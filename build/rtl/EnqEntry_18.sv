...
module EnqEntry_18(
  ...
  wire        entryUpdate_status_firstIssue =
    entryReg_status_firstIssue & entryReg_status_issueTimer == 3'h3
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        entryReg_status_issued = _RANDOM[3'h2][17];
        entryReg_status_firstIssue = _RANDOM[3'h2][18];
        entryReg_status_issueTimer = _RANDOM[3'h2][21:19];
        entryReg_payload_og1Payload_isRVC = _RANDOM[3'h2][23];
        entryReg_payload_og1Payload_fuOpType = {_RANDOM[3'h2][31:24], _RANDOM[3'h3][0]};
        entryReg_payload_og1Payload_imm = _RANDOM[3'h3][16:5];
        entryReg_payload_og1Payload_storeSetHit = _RANDOM[3'h3][17];
        entryReg_payload_og1Payload_ssid = _RANDOM[3'h3][22:18];
        entryReg_payload_og1Payload_sqIdx_flag = _RANDOM[3'h3][23];
        entryReg_payload_og1Payload_sqIdx_value = _RANDOM[3'h3][29:24];
        entryReg_payload_ftqPtr_value = {_RANDOM[3'h3][31], _RANDOM[3'h4][4:0]};
        entryReg_payload_ftqOffset = _RANDOM[3'h4][9:5];
        entryReg_payload_srcType_0 = _RANDOM[3'h4][13:10];
        entryReg_payload_rfWen = _RANDOM[3'h5][22];
        entryReg_payload_pdest = _RANDOM[3'h5][30:23];
        enqDelayValidReg_last_REG = _RANDOM[3'h6][13];
        ...
        io_commonOut_entry_bits_payload_og1Payload_REG_sqIdx_value = _RANDOM[3'h7][20:15];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        validReg_last_REG = 1'h0;
        enqDelayValidReg_last_REG = 1'h0;
