...
module VSegmentUnit(
  ...
  wire              _GEN_30 = _GEN_22 & fieldActiveWirteFinish;
  wire              _GEN_31 = _GEN_26 | _GEN_30;
  wire [3:0]        _fieldIdxWire_T_3 = _fieldIdxWire_T ? 4'h0 : 4'(fieldIdx + 4'h1);
  wire              _GEN_32 = _fieldIdxWire_T & (_segmentInactiveFinish_T | _GEN_30);
  wire              _GEN_33 = segmentIdx != _maxSegIdx_T;
  wire              _GEN_34 = _GEN_32 & _GEN_33;
  wire              _GEN_35 = segmentInactiveFinish & _GEN_33;
  ...
  wire [4:0]        _GEN_36 = {3'h0, io_in_bits_vpu_veew};
  wire [2:0]        _GEN_37 = {1'h0, _emul_T_3 == 3'h5, 1'h0};
  ...
  wire              _GEN_61 = _GEN_16 & enqPtr_value == 3'h0;
  wire              _GEN_62 = _GEN_16 & enqPtr_value == 3'h1;
  wire              _GEN_63 = _GEN_16 & enqPtr_value == 3'h2;
  wire              _GEN_64 = _GEN_16 & enqPtr_value == 3'h3;
  wire              _GEN_65 = _GEN_16 & enqPtr_value == 3'h4;
  wire              _GEN_66 = _GEN_16 & enqPtr_value == 3'h5;
  wire              _GEN_67 = _GEN_16 & enqPtr_value == 3'h6;
  wire              _GEN_68 = _GEN_16 & (&enqPtr_value);
  ...
  wire              _GEN_69 = _GEN_23 & canTriggerException;
  ...
  wire [6:0]        _GEN_83 = _GEN_82[deqPtr_value];
  wire [2:0]        _vdIdxInField_T_2 =
    io_in_bits_fuOpType[5] ? instMicroOp_uop_vpu_vlmul : _issueEmul_T_3;
  wire [2:0]        vdIdxInField =
    {1'h0,
     {1'h0, _vdIdxInField_T_2 == 3'h1 & _GEN_83[0]}
       | (_vdIdxInField_T_2 == 3'h2 ? _GEN_83[1:0] : 2'h0)}
    | (_vdIdxInField_T_2 == 3'h3 ? _GEN_83[2:0] : 3'h0);
  always @(posedge clock) begin
      ...
      instMicroOp_uopFlowNumMask <=
        8'({3'h0,
            (io_in_bits_fuOpType[6:5] == 2'h0
               ? ({1'h0, {1'h0, _GEN_37 | {_uopFlowNum_T_158, 2'h0}} | {&_emul_T_3, 3'h0}}
                  | {_uopFlowNum_T_160, 4'h0} | {_uopFlowNum_T_161, 4'h0}
                  | {_uopFlowNum_T_162, 4'h0} | {_uopFlowNum_T_163, 4'h0}) >> _GEN_36
               : 5'h0)
              | (io_in_bits_fuOpType[6:5] == 2'h2
                   ? ({1'h0,
                       {1'h0, _GEN_37 | {_uopFlowNum_T_158, 2'h0}} | {&_emul_T_3, 3'h0}}
                      | {_uopFlowNum_T_160, 4'h0} | {_uopFlowNum_T_161, 4'h0}
                      | {_uopFlowNum_T_162, 4'h0} | {_uopFlowNum_T_163, 4'h0}) >> _GEN_36
                   : 5'h0)
    ...
    if (writebackValid) begin
      ...
      io_uopwriteback_bits_r_pdest <=
        fofFixVlValid ? fofBuffer_pdest[6:0] : _GEN_54[deqPtr_value][6:0];
      ...
      io_uopwriteback_bits_r_vecWen <=
        fofFixVlValid ? fofBuffer_vecWen : _GEN_55[deqPtr_value];
      io_uopwriteback_bits_r_v0Wen <=
        fofFixVlValid ? fofBuffer_v0Wen : _GEN_56[deqPtr_value];
      io_uopwriteback_bits_r_vlWen <=
        fofFixVlValid ? fofBuffer_vlWen : _GEN_57[deqPtr_value];
      ...
      io_uopwriteback_bits_r_vls_vpu_vuopIdx <=
        fofFixVlValid ? fofBuffer_vpu_vuopIdx : _GEN_83;
      io_uopwriteback_bits_r_vls_vpu_vmask <=
        fofFixVlValid
          ? 128'hFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF
          : {112'h0, _GEN_58[vdIdxInField]};
  ...
  wire [15:0]       _GEN_88 =
    _GEN_87[15:0]
    | (latchVaddr[3:0] == 4'hE ? io_rdcache_resp_bits_data_delayed[127:112] : 16'h0);
  wire              _GEN_89 = _GEN_2 & isMisalignWire & ~_GEN_3;
  wire              _GEN_90 =
    _io_exceptionInfo_valid_T | _segmentInactiveFinish_T | _GEN_22;
  wire              _GEN_91 = stateNext == 4'hA;
  wire [3:0]        _GEN_92 = {deqPtr_flag, deqPtr_value};
  wire [7:0]        _GEN_93 = {5'h0, issueMaxIdxInIndexLog2};
  wire              _GEN_94 = isEnqFixVlUop & ~fofBufferValid;
  wire [3:0]        _deqPtr_new_ptr_T_1 = 4'(_GEN_92 + 4'h1);
  wire [7:0]        _strideOffsetWire_T_2 =
    (_GEN_14
       ? 8'h0
       : _GEN_34
           ? _segmentIdxWire_T_2[7:0]
           : _GEN_35 ? _segmentIdxWire_T_2[7:0] : segmentIdx) >> _GEN_93;
  wire [7:0]        _strideOffset_T_2 = segmentIdx >> _GEN_93;
  wire [3:0]        _splitPtrNext_new_ptr_T_1 = 4'(_GEN_92 + _splitPtrNext_T_4[3:0]);
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      if (_GEN_14 | _GEN_34 | _GEN_35) begin
        if (_GEN_14)
          segmentIdx <= 8'h0;
        else if (_GEN_34)
      ...
      if (_GEN_14 | _GEN_31 | segmentInactiveFinish) begin
        if (_GEN_14)
          fieldIdx <= 4'h0;
        else if (_GEN_31)
      ...
      if (_GEN_32 | segmentInactiveFinish)
        segmentOffset <=
          64'(segmentOffset
              + ((|(instMicroOp_uop_fuOpType[6:5]))
      ...
      fofBuffer_vecWen <=
        ~fofFixVlValid & (_GEN_94 ? io_in_bits_vecWen : fofBuffer_vecWen);
      fofBuffer_v0Wen <= ~fofFixVlValid & (_GEN_94 ? io_in_bits_v0Wen : fofBuffer_v0Wen);
      fofBuffer_vlWen <= ~fofFixVlValid & (_GEN_94 ? io_in_bits_vlWen : fofBuffer_vlWen);
      fofBuffer_vpu_vma <=
        ~fofFixVlValid & (_GEN_94 ? io_in_bits_vpu_vma : fofBuffer_vpu_vma);
      fofBuffer_vpu_vta <=
        ~fofFixVlValid & (_GEN_94 ? io_in_bits_vpu_vta : fofBuffer_vpu_vta);
      fofBuffer_vpu_vm <=
        ~fofFixVlValid & (_GEN_94 ? io_in_bits_vpu_vm : fofBuffer_vpu_vm);
      fofBuffer_robIdx_flag <=
        ~fofFixVlValid & (_GEN_94 ? io_in_bits_robIdx_flag : fofBuffer_robIdx_flag);
      fofBufferValid <= ~fofFixVlValid & (_GEN_94 | fofBufferValid);
      state <= stateNext;
      curPtr <=
        ~_GEN_90
        & (instMicroOp_isVSegLoad
             ...
             : isMisalignWire & ~notCross16ByteReg & _GEN_2
                 ? ~curPtr
                 : ~(_GEN_4 & _GEN_2 & _GEN_91) & (_GEN_4 & _GEN_91 & _GEN_11 ^ curPtr));
      isMisalignReg <= ~_GEN_90 & (_GEN_89 | ~_GEN_15 & isMisalignReg);
      notCross16ByteReg <=
        ~_GEN_90 & (_GEN_89 ? notCross16ByteWire : ~_GEN_15 & notCross16ByteReg);
      if (_GEN_6 & (|_GEN_1))
        combinedData <=
          curPtr
            ? (latchVaddr[3:0] == 4'h9
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        instMicroOp_paddr =
          {_RANDOM[10'h2A][31:25], _RANDOM[10'h2B], _RANDOM[10'h2C][8:0]};
        instMicroOp_mask =
          {_RANDOM[10'h2C][31:9],
           _RANDOM[10'h2D],
           _RANDOM[10'h2E],
           _RANDOM[10'h2F],
           _RANDOM[10'h30][8:0]};
        instMicroOp_alignedType = _RANDOM[10'h30][11:9];
        instMicroOp_vl = _RANDOM[10'h30][19:12];
        instMicroOp_uopFlowNumMask = {_RANDOM[10'h30][31:28], _RANDOM[10'h31][3:0]};
        instMicroOp_isVSegLoad = _RANDOM[10'h31][4];
        instMicroOp_isVSegStore = _RANDOM[10'h31][5];
        instMicroOp_exceptionVaddr =
          {_RANDOM[10'h31][31:14], _RANDOM[10'h32], _RANDOM[10'h33][13:0]};
        instMicroOp_exceptionGpaddr =
          {_RANDOM[10'h33][31:14], _RANDOM[10'h34], _RANDOM[10'h35][13:0]};
        instMicroOp_exceptionIsForVSnonLeafPTE = _RANDOM[10'h35][14];
        instMicroOp_exceptionVstart = _RANDOM[10'h35][25:18];
        instMicroOp_exceptionVl_bits = {_RANDOM[10'h35][31:27], _RANDOM[10'h36][2:0]};
        instMicroOp_isFof = _RANDOM[10'h36][3];
        instMicroOpValid = _RANDOM[10'h36][4];
        data_0 =
          {_RANDOM[10'h36][31:5],
           _RANDOM[10'h37],
           _RANDOM[10'h38],
        ...
        data_7 =
          {_RANDOM[10'h52][31:5],
           ...
           _RANDOM[10'h55],
           _RANDOM[10'h56][4:0]};
        uopq_0_uop_vecWen = _RANDOM[10'h5C][26];
        uopq_0_uop_v0Wen = _RANDOM[10'h5C][27];
        uopq_0_uop_vlWen = _RANDOM[10'h5C][28];
        uopq_0_uop_vpu_vuopIdx = _RANDOM[10'h5F][28:22];
        uopq_0_uop_pdest = _RANDOM[10'h68][9:2];
        uopq_0_uop_sqIdx_flag = _RANDOM[10'h7E][16];
        uopq_0_uop_sqIdx_value = _RANDOM[10'h7E][22:17];
        uopq_1_uop_vecWen = _RANDOM[10'h85][19];
        uopq_1_uop_v0Wen = _RANDOM[10'h85][20];
        uopq_1_uop_vlWen = _RANDOM[10'h85][21];
        uopq_1_uop_vpu_vuopIdx = _RANDOM[10'h88][21:15];
        uopq_1_uop_pdest = {_RANDOM[10'h90][31:27], _RANDOM[10'h91][2:0]};
        uopq_1_uop_sqIdx_flag = _RANDOM[10'hA7][9];
        uopq_1_uop_sqIdx_value = _RANDOM[10'hA7][15:10];
        uopq_2_uop_vecWen = _RANDOM[10'hAE][12];
        uopq_2_uop_v0Wen = _RANDOM[10'hAE][13];
        uopq_2_uop_vlWen = _RANDOM[10'hAE][14];
        uopq_2_uop_vpu_vuopIdx = _RANDOM[10'hB1][14:8];
        uopq_2_uop_pdest = _RANDOM[10'hB9][27:20];
        uopq_2_uop_sqIdx_flag = _RANDOM[10'hD0][2];
        uopq_2_uop_sqIdx_value = _RANDOM[10'hD0][8:3];
        uopq_3_uop_vecWen = _RANDOM[10'hD7][5];
        uopq_3_uop_v0Wen = _RANDOM[10'hD7][6];
        uopq_3_uop_vlWen = _RANDOM[10'hD7][7];
        uopq_3_uop_vpu_vuopIdx = _RANDOM[10'hDA][7:1];
        uopq_3_uop_pdest = _RANDOM[10'hE2][20:13];
        uopq_3_uop_sqIdx_flag = _RANDOM[10'hF8][27];
        uopq_3_uop_sqIdx_value = {_RANDOM[10'hF8][31:28], _RANDOM[10'hF9][1:0]};
        uopq_4_uop_vecWen = _RANDOM[10'hFF][30];
        uopq_4_uop_v0Wen = _RANDOM[10'hFF][31];
        uopq_4_uop_vlWen = _RANDOM[10'h100][0];
        uopq_4_uop_vpu_vuopIdx = {_RANDOM[10'h102][31:26], _RANDOM[10'h103][0]};
        uopq_4_uop_pdest = _RANDOM[10'h10B][13:6];
        uopq_4_uop_sqIdx_flag = _RANDOM[10'h121][20];
        uopq_4_uop_sqIdx_value = _RANDOM[10'h121][26:21];
        uopq_5_uop_vecWen = _RANDOM[10'h128][23];
        uopq_5_uop_v0Wen = _RANDOM[10'h128][24];
        uopq_5_uop_vlWen = _RANDOM[10'h128][25];
        uopq_5_uop_vpu_vuopIdx = _RANDOM[10'h12B][25:19];
        uopq_5_uop_pdest = {_RANDOM[10'h133][31], _RANDOM[10'h134][6:0]};
        uopq_5_uop_sqIdx_flag = _RANDOM[10'h14A][13];
        uopq_5_uop_sqIdx_value = _RANDOM[10'h14A][19:14];
        uopq_6_uop_vecWen = _RANDOM[10'h151][16];
        uopq_6_uop_v0Wen = _RANDOM[10'h151][17];
        uopq_6_uop_vlWen = _RANDOM[10'h151][18];
        uopq_6_uop_vpu_vuopIdx = _RANDOM[10'h154][18:12];
        uopq_6_uop_pdest = _RANDOM[10'h15C][31:24];
        uopq_6_uop_sqIdx_flag = _RANDOM[10'h173][6];
        uopq_6_uop_sqIdx_value = _RANDOM[10'h173][12:7];
        uopq_7_uop_vecWen = _RANDOM[10'h17A][9];
        uopq_7_uop_v0Wen = _RANDOM[10'h17A][10];
        uopq_7_uop_vlWen = _RANDOM[10'h17A][11];
        uopq_7_uop_vpu_vuopIdx = _RANDOM[10'h17D][11:5];
        uopq_7_uop_pdest = _RANDOM[10'h185][24:17];
        uopq_7_uop_sqIdx_flag = _RANDOM[10'h19B][31];
        uopq_7_uop_sqIdx_value = _RANDOM[10'h19C][5:0];
        stride_0 =
          {_RANDOM[10'h19C][31:13],
           _RANDOM[10'h19D],
           _RANDOM[10'h19E],
           _RANDOM[10'h19F],
           _RANDOM[10'h1A0][12:0]};
        stride_1 =
          {_RANDOM[10'h1A0][31:13],
           _RANDOM[10'h1A1],
           _RANDOM[10'h1A2],
           _RANDOM[10'h1A3],
           _RANDOM[10'h1A4][12:0]};
        stride_2 =
          {_RANDOM[10'h1A4][31:13],
           _RANDOM[10'h1A5],
           _RANDOM[10'h1A6],
           _RANDOM[10'h1A7],
           _RANDOM[10'h1A8][12:0]};
        stride_3 =
          {_RANDOM[10'h1A8][31:13],
           _RANDOM[10'h1A9],
           _RANDOM[10'h1AA],
           _RANDOM[10'h1AB],
           _RANDOM[10'h1AC][12:0]};
        stride_4 =
          {_RANDOM[10'h1AC][31:13],
           _RANDOM[10'h1AD],
           _RANDOM[10'h1AE],
           _RANDOM[10'h1AF],
           _RANDOM[10'h1B0][12:0]};
        stride_5 =
          {_RANDOM[10'h1B0][31:13],
           _RANDOM[10'h1B1],
           _RANDOM[10'h1B2],
           _RANDOM[10'h1B3],
           _RANDOM[10'h1B4][12:0]};
        stride_6 =
          {_RANDOM[10'h1B4][31:13],
           _RANDOM[10'h1B5],
           _RANDOM[10'h1B6],
           _RANDOM[10'h1B7],
           _RANDOM[10'h1B8][12:0]};
        stride_7 =
          {_RANDOM[10'h1B8][31:13],
           _RANDOM[10'h1B9],
           _RANDOM[10'h1BA],
           _RANDOM[10'h1BB],
           _RANDOM[10'h1BC][12:0]};
        enqPtr_flag = _RANDOM[10'h1BC][21];
        enqPtr_value = _RANDOM[10'h1BC][24:22];
        deqPtr_flag = _RANDOM[10'h1BC][25];
        deqPtr_value = _RANDOM[10'h1BC][28:26];
        stridePtrReg_value = {_RANDOM[10'h1BC][31:30], _RANDOM[10'h1BD][0]};
        segmentIdx = _RANDOM[10'h1BD][8:1];
        fieldIdx = _RANDOM[10'h1BD][12:9];
        segmentOffset =
          {_RANDOM[10'h1BD][31:13], _RANDOM[10'h1BE], _RANDOM[10'h1BF][12:0]};
        splitPtr_flag = _RANDOM[10'h1BF][13];
        splitPtr_value = _RANDOM[10'h1BF][16:14];
        latchVaddr = {_RANDOM[10'h1BF][31:17], _RANDOM[10'h1C0], _RANDOM[10'h1C1][16:0]};
        latchVaddrDup =
          {_RANDOM[10'h1C1][31:17], _RANDOM[10'h1C2], _RANDOM[10'h1C3][16:0]};
        issueMaxIdxInIndexLog2 = _RANDOM[10'h1C3][19:17];
        fofBuffer_fuOpType = {_RANDOM[10'h1C9][31:30], _RANDOM[10'h1CA][6:0]};
        fofBuffer_vecWen = _RANDOM[10'h1CA][9];
        fofBuffer_v0Wen = _RANDOM[10'h1CA][10];
        fofBuffer_vlWen = _RANDOM[10'h1CA][11];
        fofBuffer_vpu_vma = _RANDOM[10'h1CC][1];
        fofBuffer_vpu_vta = _RANDOM[10'h1CC][2];
        fofBuffer_vpu_vsew = _RANDOM[10'h1CC][4:3];
        fofBuffer_vpu_vlmul = _RANDOM[10'h1CC][7:5];
        fofBuffer_vpu_vm = _RANDOM[10'h1CC][16];
        fofBuffer_vpu_vstart = _RANDOM[10'h1CC][24:17];
        fofBuffer_vpu_vuopIdx = _RANDOM[10'h1CD][11:5];
        fofBuffer_vpu_nf = _RANDOM[10'h1D1][23:21];
        fofBuffer_vpu_veew = _RANDOM[10'h1D1][25:24];
        fofBuffer_pdest = _RANDOM[10'h1D5][24:17];
        fofBuffer_robIdx_flag = _RANDOM[10'h1D6][12];
        fofBuffer_robIdx_value = _RANDOM[10'h1D6][21:13];
        fofBufferValid = _RANDOM[10'h1EC][13];
        state = _RANDOM[10'h1EC][17:14];
        curPtr = _RANDOM[10'h1EC][18];
        isMisalignReg = _RANDOM[10'h1EC][19];
        notCross16ByteReg = _RANDOM[10'h1EC][20];
        combinedData =
          {_RANDOM[10'h1EC][31:21], _RANDOM[10'h1ED], _RANDOM[10'h1EE][20:0]};
        lowPagePaddr = {_RANDOM[10'h1EE][31:21], _RANDOM[10'h1EF], _RANDOM[10'h1F0][4:0]};
        triggerDebugMode = _RANDOM[10'h1F4][25];
        triggerBreakpoint = _RANDOM[10'h1F4][26];
        last_REG = _RANDOM[10'h1F4][27];
        nextBaseVaddr_r =
          {_RANDOM[10'h1F4][31:28], _RANDOM[10'h1F5], _RANDOM[10'h1F6][27:0]};
        io_uopwriteback_valid_REG = _RANDOM[10'h1F6][28];
        io_uopwriteback_bits_r_data_0 =
        ...
        io_uopwriteback_bits_r_pdest = {_RANDOM[10'h1FA][31:29], _RANDOM[10'h1FB][3:0]};
        io_uopwriteback_bits_r_robIdx_flag = _RANDOM[10'h1FB][9];
        io_uopwriteback_bits_r_robIdx_value = _RANDOM[10'h1FB][18:10];
        io_uopwriteback_bits_r_vecWen = _RANDOM[10'h1FB][19];
        io_uopwriteback_bits_r_v0Wen = _RANDOM[10'h1FB][20];
        io_uopwriteback_bits_r_vlWen = _RANDOM[10'h1FB][21];
        io_uopwriteback_bits_r_exceptionVec_3 = _RANDOM[10'h1FB][25];
        io_uopwriteback_bits_r_exceptionVec_5 = _RANDOM[10'h1FB][27];
        io_uopwriteback_bits_r_exceptionVec_7 = _RANDOM[10'h1FB][29];
        io_uopwriteback_bits_r_exceptionVec_13 = _RANDOM[10'h1FC][3];
        io_uopwriteback_bits_r_exceptionVec_15 = _RANDOM[10'h1FC][5];
        io_uopwriteback_bits_r_exceptionVec_19 = _RANDOM[10'h1FC][9];
        io_uopwriteback_bits_r_exceptionVec_21 = _RANDOM[10'h1FC][11];
        io_uopwriteback_bits_r_exceptionVec_23 = _RANDOM[10'h1FC][13];
        io_uopwriteback_bits_r_trigger = _RANDOM[10'h1FC][17:14];
        io_uopwriteback_bits_r_vls_vpu_vma = _RANDOM[10'h1FC][19];
        io_uopwriteback_bits_r_vls_vpu_vta = _RANDOM[10'h1FC][20];
        io_uopwriteback_bits_r_vls_vpu_vsew = _RANDOM[10'h1FC][22:21];
        io_uopwriteback_bits_r_vls_vpu_vlmul = _RANDOM[10'h1FC][25:23];
        io_uopwriteback_bits_r_vls_vpu_vm = _RANDOM[10'h1FD][2];
        io_uopwriteback_bits_r_vls_vpu_vstart = _RANDOM[10'h1FD][10:3];
        io_uopwriteback_bits_r_vls_vpu_vuopIdx = _RANDOM[10'h1FD][29:23];
        io_uopwriteback_bits_r_vls_vpu_vmask =
          {_RANDOM[10'h1FD][31],
           _RANDOM[10'h1FE],
           _RANDOM[10'h1FF],
           _RANDOM[10'h200],
           _RANDOM[10'h201][30:0]};
        io_uopwriteback_bits_r_vls_vpu_vl = {_RANDOM[10'h201][31], _RANDOM[10'h202][6:0]};
        io_uopwriteback_bits_r_vls_vpu_nf = _RANDOM[10'h202][9:7];
        io_uopwriteback_bits_r_vls_vpu_veew = _RANDOM[10'h202][11:10];
        io_uopwriteback_bits_r_vls_vdIdx = _RANDOM[10'h203][19:17];
        io_uopwriteback_bits_r_vls_vdIdxInField = _RANDOM[10'h203][22:20];
        io_uopwriteback_bits_r_vls_isIndexed = _RANDOM[10'h203][23];
        io_uopwriteback_bits_r_vls_isMasked = _RANDOM[10'h203][24];
        io_uopwriteback_bits_r_vls_isStrided = _RANDOM[10'h203][25];
        io_uopwriteback_bits_r_vls_isWhole = _RANDOM[10'h203][26];
        io_uopwriteback_bits_r_vls_isVecLoad = _RANDOM[10'h203][27];
        io_uopwriteback_bits_r_vls_isVlm = _RANDOM[10'h203][28];
        io_feedback_valid_REG = _RANDOM[10'h207][2];
        io_feedback_bits_r_sqIdx_flag = _RANDOM[10'h207][26];
        io_feedback_bits_r_sqIdx_value = {_RANDOM[10'h207][31:27], _RANDOM[10'h208][0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        instMicroOpValid = 1'h0;
        enqPtr_flag = 1'h0;
