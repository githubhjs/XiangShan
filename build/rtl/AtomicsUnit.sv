...
module AtomicsUnit(
  ...
  wire         _io_out_bits_pdest_T = state == 4'h8;
  ...
  wire         io_out_valid_0 =
    out_valid & (_io_out_bits_pdest_T ? pdest2Valid : pdest1Valid);
  ...
  wire         difftest_gen_valid = io_out_valid_0 & _difftest_valid_T_1 & isSc;
  ...
  wire         _GEN_15 = _difftest_valid_T_1 & io_out_valid_0;
  wire         _GEN_16 = ~_GEN_15 | _io_dcache_req_bits_cmd_T_24 | _GEN_14;
  wire         _GEN_17 = state == 4'hA & io_out_valid_0;
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      if (_GEN_17)
        state <= 4'h0;
      else if (state == 4'h9 & io_out_valid_0)
        state <= 4'hA;
      else if (_io_out_bits_pdest_T & io_out_valid_0)
        state <= 4'h9;
      else if (_GEN_15)
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        uop_robIdx_flag = _RANDOM[7'h12][30];
        uop_robIdx_value = {_RANDOM[7'h12][31], _RANDOM[7'h13][7:0]};
        pdest1 = {_RANDOM[7'h28][31], _RANDOM[7'h29][6:0]};
        pdest2 = _RANDOM[7'h29][14:7];
        pdest1Valid = _RANDOM[7'h29][15];
        pdest2Valid = _RANDOM[7'h29][16];
        rs1 = {_RANDOM[7'h29][31:17], _RANDOM[7'h2A], _RANDOM[7'h2B][16:0]};
        rs2_l = {_RANDOM[7'h2B][31:17], _RANDOM[7'h2C], _RANDOM[7'h2D][16:0]};
        rs2_h = {_RANDOM[7'h2D][31:17], _RANDOM[7'h2E], _RANDOM[7'h2F][16:0]};
        rd_l = {_RANDOM[7'h2F][31:17], _RANDOM[7'h30], _RANDOM[7'h31][16:0]};
        rd_h = {_RANDOM[7'h31][31:17], _RANDOM[7'h32], _RANDOM[7'h33][16:0]};
        stdCnt = _RANDOM[7'h33][19:17];
        exceptionVec_3 = _RANDOM[7'h33][23];
        exceptionVec_4 = _RANDOM[7'h33][24];
        exceptionVec_5 = _RANDOM[7'h33][25];
        exceptionVec_6 = _RANDOM[7'h33][26];
        exceptionVec_7 = _RANDOM[7'h33][27];
        exceptionVec_13 = _RANDOM[7'h34][1];
        exceptionVec_15 = _RANDOM[7'h34][3];
        exceptionVec_19 = _RANDOM[7'h34][7];
        exceptionVec_21 = _RANDOM[7'h34][9];
        exceptionVec_23 = _RANDOM[7'h34][11];
        trigger = _RANDOM[7'h34][15:12];
        atom_override_xtval = _RANDOM[7'h34][16];
        have_sent_first_tlb_req = _RANDOM[7'h34][17];
        paddr = {_RANDOM[7'h34][31:18], _RANDOM[7'h35], _RANDOM[7'h36][1:0]};
        gpaddr = {_RANDOM[7'h36][31:2], _RANDOM[7'h37], _RANDOM[7'h38][1:0]};
        is_mmio = _RANDOM[7'h38][2];
        isForVSnonLeafPTE = _RANDOM[7'h38][3];
        resp_data =
          {_RANDOM[7'h38][31:4],
           _RANDOM[7'h39],
           _RANDOM[7'h3A],
           _RANDOM[7'h3B],
           _RANDOM[7'h3C][3:0]};
        success = _RANDOM[7'h3C][4];
        tdata_0_matchType = _RANDOM[7'h3C][6:5];
        tdata_0_select = _RANDOM[7'h3C][7];
        tdata_0_action = _RANDOM[7'h3C][12:9];
        tdata_0_chain = _RANDOM[7'h3C][13];
        tdata_0_store = _RANDOM[7'h3C][15];
        tdata_0_load = _RANDOM[7'h3C][16];
        tdata_0_tdata2 = {_RANDOM[7'h3C][31:17], _RANDOM[7'h3D], _RANDOM[7'h3E][16:0]};
        tdata_1_matchType = _RANDOM[7'h3E][18:17];
        tdata_1_select = _RANDOM[7'h3E][19];
        tdata_1_action = _RANDOM[7'h3E][24:21];
        tdata_1_chain = _RANDOM[7'h3E][25];
        tdata_1_store = _RANDOM[7'h3E][27];
        tdata_1_load = _RANDOM[7'h3E][28];
        tdata_1_tdata2 = {_RANDOM[7'h3E][31:29], _RANDOM[7'h3F], _RANDOM[7'h40][28:0]};
        tdata_2_matchType = _RANDOM[7'h40][30:29];
        tdata_2_select = _RANDOM[7'h40][31];
        tdata_2_action = _RANDOM[7'h41][4:1];
        tdata_2_chain = _RANDOM[7'h41][5];
        tdata_2_store = _RANDOM[7'h41][7];
        tdata_2_load = _RANDOM[7'h41][8];
        tdata_2_tdata2 = {_RANDOM[7'h41][31:9], _RANDOM[7'h42], _RANDOM[7'h43][8:0]};
        tdata_3_matchType = _RANDOM[7'h43][10:9];
        tdata_3_select = _RANDOM[7'h43][11];
        tdata_3_action = _RANDOM[7'h43][16:13];
        tdata_3_chain = _RANDOM[7'h43][17];
        tdata_3_store = _RANDOM[7'h43][19];
        tdata_3_load = _RANDOM[7'h43][20];
        tdata_3_tdata2 = {_RANDOM[7'h43][31:21], _RANDOM[7'h44], _RANDOM[7'h45][20:0]};
        tEnableVec_0 = _RANDOM[7'h45][21];
        tEnableVec_1 = _RANDOM[7'h45][22];
        tEnableVec_2 = _RANDOM[7'h45][23];
        tEnableVec_3 = _RANDOM[7'h45][24];
        backendTriggerCanFireVec_0 = _RANDOM[7'h45][25];
        backendTriggerCanFireVec_1 = _RANDOM[7'h45][26];
        backendTriggerCanFireVec_2 = _RANDOM[7'h45][27];
        backendTriggerCanFireVec_3 = _RANDOM[7'h45][28];
        pbmtReg = _RANDOM[7'h45][30:29];
        dcache_resp_data =
          {_RANDOM[7'h45][31],
           _RANDOM[7'h46],
           _RANDOM[7'h47],
           _RANDOM[7'h48],
           _RANDOM[7'h49][30:0]};
        dcache_resp_id = {_RANDOM[7'h49][31], _RANDOM[7'h4A][4:0]};
        dcache_resp_tl_error_tl_denied = _RANDOM[7'h4A][5];
        dcache_resp_tl_error_tl_corrupt = _RANDOM[7'h4A][6];
        io_feedbackSlow_valid_last_REG = _RANDOM[7'h4A][7];
        io_feedbackSlow_valid_last_REG_1 = _RANDOM[7'h4A][8];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        state = 4'h0;
        out_valid = 1'h0;
  ...
  assign io_out_bits_data_0 = _io_out_bits_pdest_T ? resp_data[127:64] : resp_data[63:0];
  assign io_out_bits_pdest = _io_out_bits_pdest_T ? pdest2 : pdest1;
  assign io_out_bits_robIdx_flag = uop_robIdx_flag;
  assign io_out_bits_robIdx_value = uop_robIdx_value;
  assign io_out_bits_intWen = _difftest_valid_T_1 | _io_out_bits_pdest_T;
  assign io_out_bits_exceptionVec_3 = exceptionVec_3;
  assign io_out_bits_exceptionVec_4 = exceptionVec_4;
  assign io_out_bits_exceptionVec_5 = exceptionVec_5;
  assign io_out_bits_exceptionVec_6 = exceptionVec_6;
  assign io_out_bits_exceptionVec_7 = exceptionVec_7;
  assign io_out_bits_exceptionVec_13 = exceptionVec_13;
  assign io_out_bits_exceptionVec_15 = exceptionVec_15;
  assign io_out_bits_exceptionVec_19 = exceptionVec_19;
  assign io_out_bits_exceptionVec_21 = exceptionVec_21;
  assign io_out_bits_exceptionVec_23 = exceptionVec_23;
  assign io_out_bits_trigger = trigger;
