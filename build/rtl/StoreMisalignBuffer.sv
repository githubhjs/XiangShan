...
module StoreMisalignBuffer(
  ...
  output        io_splitStoreReq_bits_uop_isRVC,
  output [5:0]  io_splitStoreReq_bits_uop_ftqPtr_value,
  output [4:0]  io_splitStoreReq_bits_uop_ftqOffset,
  ...
  output [8:0]  io_splitStoreReq_bits_uop_robIdx_value,
  ...
  input  [8:0]  io_splitStoreResp_bits_uop_robIdx_value,
  ...
  input  [8:0]  io_sqControl_toStoreMisalignBuffer_uop_robIdx_value,
  output        io_toVecSplit_empty,
  output        io_toVecSplit_robIdx_flag,
  output [8:0]  io_toVecSplit_robIdx_value,
  ...
  wire             reqSel_oldest_bits_uop_robIdx_flag =
    _reqSel_oldestIndex_T
      ...
      : _reqSel_oldest_T_8
          ? io_enq_0_req_bits_uop_robIdx_flag
          : io_enq_1_req_bits_uop_robIdx_flag;
  wire [8:0]       reqSel_oldest_bits_uop_robIdx_value =
    _reqSel_oldestIndex_T
      ? (_reqSel_oldest_T_5
  ...
  wire [1:0]       reqSelCanEnq = 2'h1 << reqSel_3_0;
  wire             _io_enq_1_req_ready_T_2 = _GEN & _GEN_1;
  ...
  wire             _io_sqControl_toStoreQueue_crossPageCanDeq_T_1 = bufferState == 3'h5;
  ...
  wire             _GEN_11 = ~cross16BytesBoundary | alignedType == 2'h0;
  wire             _GEN_12 = ~_GEN_2 | _GEN_11;
  wire [49:0]      lowAddrStore_vaddr = _GEN_12 ? 50'h0 : _GEN_10[alignedType];
  wire [7:0][49:0] _GEN_13 =
    {{50'(req_vaddr + 50'h1)},
     {50'(req_vaddr + 50'h2)},
     {50'(req_vaddr + 50'h3)},
     {50'(req_vaddr + 50'h4)},
     ...
     {50'(req_vaddr + 50'h7)},
     {50'h0}};
  wire [3:0][49:0] _GEN_14 =
    {{_GEN_13[req_vaddr[2:0]]},
     {_GEN_8[req_vaddr[1:0]]},
     {50'(req_vaddr + 50'h1)},
     {50'h0}};
  wire [49:0]      highAddrStore_vaddr = _GEN_12 ? 50'h0 : _GEN_14[alignedType];
  ...
  wire             io_writeBack_valid_0 =
    req_valid & _io_vecWriteBack_1_valid_T & ~req_isvec;
  wire             _io_writeBack_bits_exceptionVec_19_T = globalUncache | globalException;
  wire [1:0]       _io_vecWriteBack_1_valid_T_3 = 2'h1 << req_portIndex;
  wire             io_vecWriteBack_0_valid_0 =
    req_valid & _io_vecWriteBack_1_valid_T & req_isvec & _io_vecWriteBack_1_valid_T_3[0];
  wire [63:0]      io_vecWriteBack_1_bits_vaddr_0 = {14'h0, req_vaddr};
  wire             io_vecWriteBack_1_valid_0 =
    req_valid & _io_vecWriteBack_1_valid_T & req_isvec & _io_vecWriteBack_1_valid_T_3[1];
  ...
  wire             _GEN_30 =
    io_vecWriteBack_0_ready & io_vecWriteBack_0_valid_0 | io_vecWriteBack_1_ready
    & io_vecWriteBack_1_valid_0;
  wire             _GEN_31 = io_writeBack_ready & io_writeBack_valid_0;
  wire             _GEN_32 = _GEN_31 & (~isCrossPage | globalUncache | globalException);
  wire             _GEN_33 =
    _io_sqControl_toStoreQueue_crossPageCanDeq_T_1
  ...
  wire [8:0]       _GEN_39 =
    req_vaddr[2:0] == 3'h5 | req_vaddr[2:0] == 3'h6 | (&(req_vaddr[2:0]))
      ...
      : req_uop_fuOpType;
  wire             _GEN_40 =
    io_splitStoreResp_valid & _GEN_27
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      if (_GEN_37) begin
        splitStoreReqs_0_uop_exceptionVec_0 <= req_uop_exceptionVec_0;
        splitStoreReqs_0_uop_exceptionVec_1 <= req_uop_exceptionVec_1;
        splitStoreReqs_0_uop_exceptionVec_2 <= req_uop_exceptionVec_2;
        splitStoreReqs_0_uop_exceptionVec_4 <= req_uop_exceptionVec_4;
        splitStoreReqs_0_uop_exceptionVec_5 <= req_uop_exceptionVec_5;
        splitStoreReqs_0_uop_exceptionVec_8 <= req_uop_exceptionVec_8;
        splitStoreReqs_0_uop_exceptionVec_9 <= req_uop_exceptionVec_9;
        splitStoreReqs_0_uop_exceptionVec_10 <= req_uop_exceptionVec_10;
        splitStoreReqs_0_uop_exceptionVec_11 <= req_uop_exceptionVec_11;
        splitStoreReqs_0_uop_exceptionVec_12 <= req_uop_exceptionVec_12;
        splitStoreReqs_0_uop_exceptionVec_13 <= req_uop_exceptionVec_13;
        splitStoreReqs_0_uop_exceptionVec_14 <= req_uop_exceptionVec_14;
        splitStoreReqs_0_uop_exceptionVec_16 <= req_uop_exceptionVec_16;
        splitStoreReqs_0_uop_exceptionVec_17 <= req_uop_exceptionVec_17;
        splitStoreReqs_0_uop_exceptionVec_18 <= req_uop_exceptionVec_18;
        splitStoreReqs_0_uop_exceptionVec_19 <= req_uop_exceptionVec_19;
        splitStoreReqs_0_uop_exceptionVec_20 <= req_uop_exceptionVec_20;
        splitStoreReqs_0_uop_exceptionVec_21 <= req_uop_exceptionVec_21;
        splitStoreReqs_0_uop_exceptionVec_22 <= req_uop_exceptionVec_22;
        splitStoreReqs_0_uop_trigger <= req_uop_trigger;
        splitStoreReqs_0_uop_isRVC <= req_uop_isRVC;
        splitStoreReqs_0_uop_ftqPtr_value <= req_uop_ftqPtr_value;
        splitStoreReqs_0_uop_ftqOffset <= req_uop_ftqOffset;
        splitStoreReqs_0_uop_fuOpType <= _GEN_46[alignedType];
        splitStoreReqs_0_uop_uopIdx <= req_uop_uopIdx;
        splitStoreReqs_0_uop_robIdx_flag <= req_uop_robIdx_flag;
        splitStoreReqs_0_uop_robIdx_value <= req_uop_robIdx_value;
        splitStoreReqs_0_uop_sqIdx_flag <= req_uop_sqIdx_flag;
        splitStoreReqs_0_uop_sqIdx_value <= req_uop_sqIdx_value;
      ...
      if (_GEN_37) begin
        splitStoreReqs_1_uop_exceptionVec_0 <= req_uop_exceptionVec_0;
        splitStoreReqs_1_uop_exceptionVec_1 <= req_uop_exceptionVec_1;
        splitStoreReqs_1_uop_exceptionVec_2 <= req_uop_exceptionVec_2;
        splitStoreReqs_1_uop_exceptionVec_4 <= req_uop_exceptionVec_4;
        splitStoreReqs_1_uop_exceptionVec_5 <= req_uop_exceptionVec_5;
        splitStoreReqs_1_uop_exceptionVec_8 <= req_uop_exceptionVec_8;
        splitStoreReqs_1_uop_exceptionVec_9 <= req_uop_exceptionVec_9;
        splitStoreReqs_1_uop_exceptionVec_10 <= req_uop_exceptionVec_10;
        splitStoreReqs_1_uop_exceptionVec_11 <= req_uop_exceptionVec_11;
        splitStoreReqs_1_uop_exceptionVec_12 <= req_uop_exceptionVec_12;
        splitStoreReqs_1_uop_exceptionVec_13 <= req_uop_exceptionVec_13;
        splitStoreReqs_1_uop_exceptionVec_14 <= req_uop_exceptionVec_14;
        splitStoreReqs_1_uop_exceptionVec_16 <= req_uop_exceptionVec_16;
        splitStoreReqs_1_uop_exceptionVec_17 <= req_uop_exceptionVec_17;
        splitStoreReqs_1_uop_exceptionVec_18 <= req_uop_exceptionVec_18;
        splitStoreReqs_1_uop_exceptionVec_19 <= req_uop_exceptionVec_19;
        splitStoreReqs_1_uop_exceptionVec_20 <= req_uop_exceptionVec_20;
        splitStoreReqs_1_uop_exceptionVec_21 <= req_uop_exceptionVec_21;
        splitStoreReqs_1_uop_exceptionVec_22 <= req_uop_exceptionVec_22;
        splitStoreReqs_1_uop_trigger <= req_uop_trigger;
        splitStoreReqs_1_uop_isRVC <= req_uop_isRVC;
        splitStoreReqs_1_uop_ftqPtr_value <= req_uop_ftqPtr_value;
        splitStoreReqs_1_uop_ftqOffset <= req_uop_ftqOffset;
        splitStoreReqs_1_uop_fuOpType <= _GEN_48[alignedType];
        splitStoreReqs_1_uop_uopIdx <= req_uop_uopIdx;
        splitStoreReqs_1_uop_robIdx_flag <= req_uop_robIdx_flag;
        splitStoreReqs_1_uop_robIdx_value <= req_uop_robIdx_value;
        splitStoreReqs_1_uop_sqIdx_flag <= req_uop_sqIdx_flag;
        splitStoreReqs_1_uop_sqIdx_value <= req_uop_sqIdx_value;
      ...
      curPtr <=
        ~_GEN_41
        & (~_GEN_40 | _GEN_4 | io_splitStoreResp_bits_need_rep
             ? _GEN_38
               & (_GEN_34
                    ? curPtr
                    : _GEN_29
  ...
  always @(posedge clock) begin
    ...
    req_vaNeedExt <= _GEN ? ~_GEN_1 & req_vaNeedExt : ~canEnq & req_vaNeedExt;
    if (_GEN_50)
      req_mask <=
        _reqSel_oldestIndex_T
    ...
    req_isForVSnonLeafPTE <=
      _GEN ? ~_GEN_1 & req_isForVSnonLeafPTE : ~canEnq & req_isForVSnonLeafPTE;
    if (_GEN_50) begin
      req_isvec <=
        _reqSel_oldestIndex_T
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    logic [31:0] _RANDOM[0:317];
    initial begin
      `ifdef INIT_RANDOM_PROLOG_
        `INIT_RANDOM_PROLOG_
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT
        for (logic [8:0] i = 9'h0; i < 9'h13E; i += 9'h1) begin
          _RANDOM[i] = `RANDOM;
        end
        ...
        req_uop_uopIdx = _RANDOM[9'hF][14:8];
        ...
        req_portIndex = _RANDOM[9'h3F][8];
        bufferState = _RANDOM[9'h3F][12:10];
        s2_canEnq_next_r = _RANDOM[9'h3F][13];
        s2_reqSelPort_next_r = _RANDOM[9'h3F][14];
        splitStoreReqs_0_uop_exceptionVec_0 = _RANDOM[9'h42][11];
        splitStoreReqs_0_uop_exceptionVec_1 = _RANDOM[9'h42][12];
        splitStoreReqs_0_uop_exceptionVec_2 = _RANDOM[9'h42][13];
        splitStoreReqs_0_uop_exceptionVec_4 = _RANDOM[9'h42][15];
        splitStoreReqs_0_uop_exceptionVec_5 = _RANDOM[9'h42][16];
        splitStoreReqs_0_uop_exceptionVec_8 = _RANDOM[9'h42][19];
        splitStoreReqs_0_uop_exceptionVec_9 = _RANDOM[9'h42][20];
        splitStoreReqs_0_uop_exceptionVec_10 = _RANDOM[9'h42][21];
        splitStoreReqs_0_uop_exceptionVec_11 = _RANDOM[9'h42][22];
        splitStoreReqs_0_uop_exceptionVec_12 = _RANDOM[9'h42][23];
        splitStoreReqs_0_uop_exceptionVec_13 = _RANDOM[9'h42][24];
        splitStoreReqs_0_uop_exceptionVec_14 = _RANDOM[9'h42][25];
        splitStoreReqs_0_uop_exceptionVec_16 = _RANDOM[9'h42][27];
        splitStoreReqs_0_uop_exceptionVec_17 = _RANDOM[9'h42][28];
        splitStoreReqs_0_uop_exceptionVec_18 = _RANDOM[9'h42][29];
        splitStoreReqs_0_uop_exceptionVec_19 = _RANDOM[9'h42][30];
        splitStoreReqs_0_uop_exceptionVec_20 = _RANDOM[9'h42][31];
        splitStoreReqs_0_uop_exceptionVec_21 = _RANDOM[9'h43][0];
        splitStoreReqs_0_uop_exceptionVec_22 = _RANDOM[9'h43][1];
        splitStoreReqs_0_uop_trigger = _RANDOM[9'h43][8:5];
        splitStoreReqs_0_uop_isRVC = _RANDOM[9'h43][9];
        splitStoreReqs_0_uop_ftqPtr_value = _RANDOM[9'h43][19:14];
        splitStoreReqs_0_uop_ftqOffset = _RANDOM[9'h43][24:20];
        splitStoreReqs_0_uop_fuOpType = {_RANDOM[9'h45][31:25], _RANDOM[9'h46][1:0]};
        splitStoreReqs_0_uop_uopIdx = _RANDOM[9'h4E][28:22];
        splitStoreReqs_0_uop_robIdx_flag = _RANDOM[9'h52][7];
        splitStoreReqs_0_uop_robIdx_value = _RANDOM[9'h52][16:8];
        splitStoreReqs_0_uop_sqIdx_flag = _RANDOM[9'h67][26];
        splitStoreReqs_0_uop_sqIdx_value = {_RANDOM[9'h67][31:27], _RANDOM[9'h68][0]};
        splitStoreReqs_0_vaddr = {_RANDOM[9'h68][31:8], _RANDOM[9'h69][25:0]};
        splitStoreReqs_0_mask = _RANDOM[9'h6F][26:11];
        splitStoreReqs_0_is128bit = _RANDOM[9'h78][30];
        splitStoreReqs_1_uop_exceptionVec_0 = _RANDOM[9'h81][18];
        splitStoreReqs_1_uop_exceptionVec_1 = _RANDOM[9'h81][19];
        splitStoreReqs_1_uop_exceptionVec_2 = _RANDOM[9'h81][20];
        splitStoreReqs_1_uop_exceptionVec_4 = _RANDOM[9'h81][22];
        splitStoreReqs_1_uop_exceptionVec_5 = _RANDOM[9'h81][23];
        splitStoreReqs_1_uop_exceptionVec_8 = _RANDOM[9'h81][26];
        splitStoreReqs_1_uop_exceptionVec_9 = _RANDOM[9'h81][27];
        splitStoreReqs_1_uop_exceptionVec_10 = _RANDOM[9'h81][28];
        splitStoreReqs_1_uop_exceptionVec_11 = _RANDOM[9'h81][29];
        splitStoreReqs_1_uop_exceptionVec_12 = _RANDOM[9'h81][30];
        splitStoreReqs_1_uop_exceptionVec_13 = _RANDOM[9'h81][31];
        splitStoreReqs_1_uop_exceptionVec_14 = _RANDOM[9'h82][0];
        splitStoreReqs_1_uop_exceptionVec_16 = _RANDOM[9'h82][2];
        splitStoreReqs_1_uop_exceptionVec_17 = _RANDOM[9'h82][3];
        splitStoreReqs_1_uop_exceptionVec_18 = _RANDOM[9'h82][4];
        splitStoreReqs_1_uop_exceptionVec_19 = _RANDOM[9'h82][5];
        splitStoreReqs_1_uop_exceptionVec_20 = _RANDOM[9'h82][6];
        splitStoreReqs_1_uop_exceptionVec_21 = _RANDOM[9'h82][7];
        splitStoreReqs_1_uop_exceptionVec_22 = _RANDOM[9'h82][8];
        splitStoreReqs_1_uop_trigger = _RANDOM[9'h82][15:12];
        splitStoreReqs_1_uop_isRVC = _RANDOM[9'h82][16];
        splitStoreReqs_1_uop_ftqPtr_value = _RANDOM[9'h82][26:21];
        splitStoreReqs_1_uop_ftqOffset = _RANDOM[9'h82][31:27];
        splitStoreReqs_1_uop_fuOpType = _RANDOM[9'h85][8:0];
        splitStoreReqs_1_uop_uopIdx = {_RANDOM[9'h8D][31:29], _RANDOM[9'h8E][3:0]};
        splitStoreReqs_1_uop_robIdx_flag = _RANDOM[9'h91][14];
        splitStoreReqs_1_uop_robIdx_value = _RANDOM[9'h91][23:15];
        splitStoreReqs_1_uop_sqIdx_flag = _RANDOM[9'hA7][1];
        splitStoreReqs_1_uop_sqIdx_value = _RANDOM[9'hA7][7:2];
        splitStoreReqs_1_vaddr =
          {_RANDOM[9'hA7][31:15], _RANDOM[9'hA8], _RANDOM[9'hA9][0]};
        splitStoreReqs_1_mask = {_RANDOM[9'hAE][31:18], _RANDOM[9'hAF][1:0]};
        splitStoreReqs_1_is128bit = _RANDOM[9'hB8][5];
        splitStoreResp_1_paddr =
          {_RANDOM[9'h129][31:17], _RANDOM[9'h12A], _RANDOM[9'h12B][0]};
        isCrossPage = _RANDOM[9'h13C][13];
        exceptionVec_3 = _RANDOM[9'h13C][17];
        exceptionVec_6 = _RANDOM[9'h13C][20];
        exceptionVec_7 = _RANDOM[9'h13C][21];
        exceptionVec_15 = _RANDOM[9'h13C][29];
        exceptionVec_19 = _RANDOM[9'h13D][1];
        exceptionVec_23 = _RANDOM[9'h13D][5];
        unSentStores = _RANDOM[9'h13D][7:6];
        curPtr = _RANDOM[9'h13D][10];
        globalException = _RANDOM[9'h13D][11];
        globalUncache = _RANDOM[9'h13D][12];
        globalMMIO = _RANDOM[9'h13D][13];
        globalNC = _RANDOM[9'h13D][14];
        globalMemBackTypeMM = _RANDOM[9'h13D][15];
        REG = _RANDOM[9'h13D][16];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        req_valid = 1'h0;
        bufferState = 3'h0;
  ...
  assign io_enq_0_req_ready = reqSelCanEnq[0] & (~req_valid | _io_enq_1_req_ready_T_2);
  assign io_enq_1_req_ready = reqSelCanEnq[1] & (~req_valid | _io_enq_1_req_ready_T_2);
  ...
  assign io_splitStoreReq_bits_uop_isRVC =
    curPtr ? splitStoreReqs_1_uop_isRVC : splitStoreReqs_0_uop_isRVC;
  ...
  assign io_writeBack_bits_exceptionVec_3 =
    _io_writeBack_bits_exceptionVec_19_T & exceptionVec_3;
  assign io_writeBack_bits_exceptionVec_6 =
    _io_writeBack_bits_exceptionVec_19_T & exceptionVec_6;
  assign io_writeBack_bits_exceptionVec_7 =
    _io_writeBack_bits_exceptionVec_19_T & exceptionVec_7;
  assign io_writeBack_bits_exceptionVec_15 =
    _io_writeBack_bits_exceptionVec_19_T & exceptionVec_15;
  assign io_writeBack_bits_exceptionVec_19 =
    _io_writeBack_bits_exceptionVec_19_T & exceptionVec_19;
  assign io_writeBack_bits_exceptionVec_23 =
    _io_writeBack_bits_exceptionVec_19_T & exceptionVec_23;
  ...
  assign io_vecWriteBack_0_bits_gpaddr = 64'h0;
  ...
  assign io_vecWriteBack_1_bits_gpaddr = 64'h0;
  ...
  assign io_sqControl_toStoreQueue_crossPageWithHit =
    {io_sqControl_toStoreMisalignBuffer_sqPtr_flag,
     io_sqControl_toStoreMisalignBuffer_sqPtr_value} == {req_uop_sqIdx_flag,
                                                         req_uop_sqIdx_value}
    & isCrossPage;
  assign io_sqControl_toStoreQueue_crossPageCanDeq =
    ~isCrossPage | _io_sqControl_toStoreQueue_crossPageCanDeq_T_1;
