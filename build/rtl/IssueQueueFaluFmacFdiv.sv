...
module IssueQueueFaluFmacFdiv(
  ...
  output [7:0]  io_deqDelay_0_bits_psrc_2,
  ...
  wire [3:0]  _entries_io_dataSources_18_2_value;
  wire [3:0]  _entries_io_dataSources_19_0_value;
  wire [3:0]  _entries_io_dataSources_19_1_value;
  wire [3:0]  _entries_io_dataSources_19_2_value;
  ...
  reg  [7:0]  deqDelay_0_bits_psrc_2;
  ...
  always @(posedge clock) begin
    ...
    if (|_entries_io_valid) begin
      ...
      deqDelay_0_bits_dataSources_0_value <=
        ...
        | (_age_2_io_out_0[14] ? _entries_io_dataSources_18_0_value : 4'h0)
        | (_age_2_io_out_0[15] ? _entries_io_dataSources_19_0_value : 4'h0);
      deqDelay_0_bits_dataSources_1_value <=
        ...
        | (_age_2_io_out_0[14] ? _entries_io_dataSources_18_1_value : 4'h0)
        | (_age_2_io_out_0[15] ? _entries_io_dataSources_19_1_value : 4'h0);
      deqDelay_0_bits_dataSources_2_value <=
        ...
        | (_age_2_io_out_0[14] ? _entries_io_dataSources_18_2_value : 4'h0)
        | (_age_2_io_out_0[15] ? _entries_io_dataSources_19_2_value : 4'h0);
    ...
    deqDelay_0_bits_fpRen_0 <=
      deqBeforeDly_0_valid & _entries_io_deqEntry_0_bits_payload_srcType_0[1]
      & _entries_io_deqEntry_0_bits_status_srcStatus_0_dataSources_value[3];
    deqDelay_0_bits_fpRen_1 <=
      deqBeforeDly_0_valid & _entries_io_deqEntry_0_bits_payload_srcType_1[1]
      & _entries_io_deqEntry_0_bits_status_srcStatus_1_dataSources_value[3];
    deqDelay_0_bits_fpRen_2 <=
      deqBeforeDly_0_valid & _entries_io_deqEntry_0_bits_payload_srcType_2[1]
            ...
            + {1'h0,
               5'({1'h0,
                  ...
                  + {1'h0,
                     4'({1'h0,
                         3'({1'h0,
                             2'({1'h0, _entries_io_valid[11] & deqCanAcceptVec_0_11}
                           ...
                           3'({1'h0,
                              ...
                              + {1'h0,
                                 2'({1'h0, _entries_io_valid[17] & deqCanAcceptVec_0_17}
                                    + 2'({1'h0,
                                          _entries_io_valid[18] & deqCanAcceptVec_0_18}
                                         + {1'h0,
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        entries_io_compEntryOldestSelDelay_0_REG_bits = _RANDOM[3'h0][22:7];
        deqDelay_0_valid = _RANDOM[3'h0][23];
        deqDelay_0_bits_fuType = {_RANDOM[3'h0][31:24], _RANDOM[3'h1][27:0]};
        deqDelay_0_bits_robIdx_flag = _RANDOM[3'h1][28];
        deqDelay_0_bits_robIdx_value = {_RANDOM[3'h1][31:29], _RANDOM[3'h2][5:0]};
        deqDelay_0_bits_fpRen_0 = _RANDOM[3'h2][12];
        deqDelay_0_bits_fpRen_1 = _RANDOM[3'h2][13];
        deqDelay_0_bits_fpRen_2 = _RANDOM[3'h2][14];
        deqDelay_0_bits_fpWen = _RANDOM[3'h2][15];
        deqDelay_0_bits_pdest = _RANDOM[3'h2][23:16];
        deqDelay_0_bits_psrc_0 = _RANDOM[3'h2][31:24];
        deqDelay_0_bits_psrc_1 = _RANDOM[3'h3][7:0];
        deqDelay_0_bits_psrc_2 = _RANDOM[3'h3][15:8];
        deqDelay_0_bits_dataSources_0_value = _RANDOM[3'h3][19:16];
        deqDelay_0_bits_dataSources_1_value = _RANDOM[3'h3][23:20];
        deqDelay_0_bits_dataSources_2_value = _RANDOM[3'h3][27:24];
        deqDelay_0_bits_exuSources_0_value = _RANDOM[3'h3][30:28];
        deqDelay_0_bits_exuSources_1_value = {_RANDOM[3'h3][31], _RANDOM[3'h4][1:0]};
        deqDelay_0_bits_exuSources_2_value = _RANDOM[3'h4][4:2];
        deqDelay_0_bits_loadDependency_0 = _RANDOM[3'h4][6:5];
        deqDelay_0_bits_loadDependency_1 = _RANDOM[3'h4][8:7];
        deqDelay_0_bits_loadDependency_2 = _RANDOM[3'h4][10:9];
        io_validCntDeqVec_0_REG_1 = _RANDOM[3'h4][22:17];
        enqReady_last_REG = _RANDOM[3'h4][23];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        enqReady_last_REG = 1'h0;
    end // initial
  ...
  EntriesFaluFmacFdiv entries (
    ...
    .io_dataSources_18_2_value
      (_entries_io_dataSources_18_2_value),
    ...
    .io_dataSources_19_2_value
      (_entries_io_dataSources_19_2_value),
  ...
  MultiWakeupQueue_7 wakeUpQueues_0 (
    ...
    .io_enq_valid
      (deqBeforeDly_0_valid & ~_entries_io_deqEntry_0_bits_status_fuType_14),
    .io_enq_bits_uop_robIdx_flag
      (deqBeforeDly_0_valid & _entries_io_deqEntry_0_bits_status_robIdx_flag),
    .io_enq_bits_uop_robIdx_value
      (deqBeforeDly_0_valid ? _entries_io_deqEntry_0_bits_status_robIdx_value : 9'h0),
    ...
    .io_enq_bits_uop_loadDependency_0
      (deqBeforeDly_0_valid ? finalLoadDependency_0_0 : 2'h0),
    .io_enq_bits_uop_loadDependency_1
      (deqBeforeDly_0_valid ? finalLoadDependency_0_1 : 2'h0),
    .io_enq_bits_uop_loadDependency_2
      (deqBeforeDly_0_valid ? finalLoadDependency_0_2 : 2'h0),
    .io_enq_bits_lat
      ({1'h0,
        deqBeforeDly_0_valid
          ? (_entries_io_deqEntry_0_bits_status_fuType_14
