  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        ld_reorder_res_0_1_0_bits_uop_robIdx_flag = _RANDOM[10'h39][9];
        ld_reorder_res_0_1_0_bits_uop_robIdx_value = _RANDOM[10'h39][18:10];
        ld_reorder_res_0_1_0_bits_vaddr = {_RANDOM[10'h4F][31:10], _RANDOM[10'h50][27:0]};
        ld_reorder_res_0_1_0_bits_paddr =
          {_RANDOM[10'h52][31:29], _RANDOM[10'h53], _RANDOM[10'h54][12:0]};
        ld_reorder_res_0_1_1_valid = _RANDOM[10'h66][13];
        ld_reorder_res_0_1_1_bits_uop_pc = {_RANDOM[10'h67][31:14], _RANDOM[10'h68]};
        ld_reorder_res_0_1_1_bits_uop_robIdx_flag = _RANDOM[10'h79][6];
        ld_reorder_res_0_1_1_bits_uop_robIdx_value = _RANDOM[10'h79][15:7];
        ld_reorder_res_0_1_1_bits_vaddr = {_RANDOM[10'h8F][31:7], _RANDOM[10'h90][24:0]};
        ld_reorder_res_0_1_1_bits_paddr =
          {_RANDOM[10'h92][31:26], _RANDOM[10'h93], _RANDOM[10'h94][9:0]};
        ld_reorder_res_0_1_2_valid = _RANDOM[10'hA6][10];
        ld_reorder_res_0_1_2_bits_uop_pc =
          {_RANDOM[10'hA7][31:11], _RANDOM[10'hA8][28:0]};
        ld_reorder_res_0_1_2_bits_uop_robIdx_flag = _RANDOM[10'hB9][3];
        ld_reorder_res_0_1_2_bits_uop_robIdx_value = _RANDOM[10'hB9][12:4];
        ld_reorder_res_0_1_2_bits_vaddr = {_RANDOM[10'hCF][31:4], _RANDOM[10'hD0][21:0]};
        ld_reorder_res_0_1_2_bits_paddr =
          {_RANDOM[10'hD2][31:23], _RANDOM[10'hD3], _RANDOM[10'hD4][6:0]};
        ld_reorder_res_1_2_0_valid = _RANDOM[10'hE6][7];
        ld_reorder_res_1_2_0_bits_uop_pc = {_RANDOM[10'hE7][31:8], _RANDOM[10'hE8][25:0]};
        ld_reorder_res_1_2_0_bits_uop_robIdx_flag = _RANDOM[10'hF9][0];
        ld_reorder_res_1_2_0_bits_uop_robIdx_value = _RANDOM[10'hF9][9:1];
        ld_reorder_res_1_2_0_bits_vaddr =
          {_RANDOM[10'h10F][31:1], _RANDOM[10'h110][18:0]};
        ld_reorder_res_1_2_0_bits_paddr =
          {_RANDOM[10'h112][31:20], _RANDOM[10'h113], _RANDOM[10'h114][3:0]};
        ld_reorder_res_1_2_1_valid = _RANDOM[10'h126][4];
        ld_reorder_res_1_2_1_bits_uop_pc =
          {_RANDOM[10'h127][31:5], _RANDOM[10'h128][22:0]};
        ld_reorder_res_1_2_1_bits_uop_robIdx_flag = _RANDOM[10'h138][29];
        ld_reorder_res_1_2_1_bits_uop_robIdx_value =
          {_RANDOM[10'h138][31:30], _RANDOM[10'h139][6:0]};
        ld_reorder_res_1_2_1_bits_vaddr =
          {_RANDOM[10'h14E][31:30], _RANDOM[10'h14F], _RANDOM[10'h150][15:0]};
        ld_reorder_res_1_2_1_bits_paddr =
          {_RANDOM[10'h152][31:17], _RANDOM[10'h153], _RANDOM[10'h154][0]};
        ld_reorder_res_1_2_2_valid = _RANDOM[10'h166][1];
        ld_reorder_res_1_2_2_bits_uop_pc =
          {_RANDOM[10'h167][31:2], _RANDOM[10'h168][19:0]};
        ld_reorder_res_1_2_2_bits_vaddr =
          {_RANDOM[10'h18E][31:27], _RANDOM[10'h18F], _RANDOM[10'h190][12:0]};
        ld_reorder_res_1_2_2_bits_paddr =
          {_RANDOM[10'h192][31:14], _RANDOM[10'h193][29:0]};
        ld_reorder_0_valid = _RANDOM[10'h1A5][30];
        ld_reorder_0_bits_uop_pc =
          {_RANDOM[10'h1A6][31], _RANDOM[10'h1A7], _RANDOM[10'h1A8][16:0]};
        ld_reorder_0_bits_vaddr =
          {_RANDOM[10'h1CE][31:24], _RANDOM[10'h1CF], _RANDOM[10'h1D0][9:0]};
        ld_reorder_0_bits_paddr = {_RANDOM[10'h1D2][31:11], _RANDOM[10'h1D3][26:0]};
        ld_reorder_1_valid = _RANDOM[10'h1E5][27];
        ld_reorder_1_bits_uop_pc =
          {_RANDOM[10'h1E6][31:28], _RANDOM[10'h1E7], _RANDOM[10'h1E8][13:0]};
        ld_reorder_1_bits_vaddr =
          {_RANDOM[10'h20E][31:21], _RANDOM[10'h20F], _RANDOM[10'h210][6:0]};
        ld_reorder_1_bits_paddr = {_RANDOM[10'h212][31:8], _RANDOM[10'h213][23:0]};
        ld_reorder_2_valid = _RANDOM[10'h225][24];
        ld_reorder_2_bits_uop_pc =
          {_RANDOM[10'h226][31:25], _RANDOM[10'h227], _RANDOM[10'h228][10:0]};
        ld_reorder_2_bits_vaddr =
          {_RANDOM[10'h24E][31:18], _RANDOM[10'h24F], _RANDOM[10'h250][3:0]};
        ld_reorder_2_bits_paddr = {_RANDOM[10'h252][31:5], _RANDOM[10'h253][20:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        entries_0_vaddr = 50'h0;
        entries_0_paddr = 48'h0;
