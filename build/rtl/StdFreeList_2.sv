...
module StdFreeList_2(
  ...
  wire [7:0][7:0]   _GEN_20 =
    {{(headPtrOH[14] ? freeList_0 : 8'h0) | (headPtrOH[15] ? freeList_1 : 8'h0)
        ...
        | (headPtrOH[20] ? freeList_6 : 8'h0) | (headPtrOH[0] ? freeList_7 : 8'h0)
  ...
  wire [4:0]        _freeRegCnt_T_53 = 5'(_tailPtr_new_ptr_value_T_1 - 5'hB);
  wire [4:0]        freeRegCnt =
  ...
  wire [6:0]        _enqPtr_diff_T_40 = 7'({1'h0, enqPtr_new_value_6} - 7'h15);
  ...
  wire [6:0]        _enqPtr_diff_T_46 = 7'({1'h0, enqPtr_new_value_7} - 7'h15);
