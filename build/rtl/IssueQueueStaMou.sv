...
module IssueQueueStaMou(
  ...
  wire        _entries_io_isFirstIssue_0;
  ...
  always @(posedge clock) begin
    ...
    if (|_entries_io_valid) begin
      ...
      deqDelay_0_bits_isFirstIssue <= _entries_io_isFirstIssue_0;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        deqDelay_0_bits_rcIdx_0 = _RANDOM[3'h0][24:20];
        deqDelay_0_bits_fuType = {_RANDOM[3'h0][31:25], _RANDOM[3'h1][28:0]};
        deqDelay_0_bits_robIdx_flag = _RANDOM[3'h1][29];
        deqDelay_0_bits_robIdx_value = {_RANDOM[3'h1][31:30], _RANDOM[3'h2][6:0]};
        deqDelay_0_bits_isFirstIssue = _RANDOM[3'h2][11];
        deqDelay_0_bits_rfRen_0 = _RANDOM[3'h2][12];
        deqDelay_0_bits_rfWen = _RANDOM[3'h2][13];
        deqDelay_0_bits_pdest = _RANDOM[3'h2][21:14];
        deqDelay_0_bits_ftqIdx_value = _RANDOM[3'h2][28:23];
        deqDelay_0_bits_ftqOffset = {_RANDOM[3'h2][31:29], _RANDOM[3'h3][1:0]};
        deqDelay_0_bits_psrc_0 = _RANDOM[3'h3][9:2];
        ...
        io_validCntDeqVec_0_REG_1 = {_RANDOM[3'h3][31:29], _RANDOM[3'h4][1:0]};
        enqReady_last_REG = _RANDOM[3'h4][2];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        enqReady_last_REG = 1'h0;
    end // initial
  ...
  EntriesStaMou entries (
    ...
    .io_isFirstIssue_0                                       (_entries_io_isFirstIssue_0),
