...
module L2Directory_3(
  ...
  wire [103:0] sramDataOut_6;
  wire [103:0] sramDataOut_5;
  wire [103:0] sramDataOut_4;
  wire [103:0] sramDataOut_3;
  wire [103:0] sramDataOut_2;
  wire [103:0] sramDataOut_1;
  wire [103:0] sramDataOut_0;
  reg  [5:0]   arrayReg;
  reg          reqReg;
  reg          allReg;
  reg          wenReg;
  ...
  assign sramDataOut_0 = {28'h0, selectedVec_0 ? toSRAM_0_rdata : 76'h0};
  wire         selectedVec_0_1 = arrayReg == 6'h28;
  wire         doSpread_1 = selectedVec_0_1 | allReg;
  assign sramDataOut_1 = {28'h0, selectedVec_0_1 ? toSRAM_1_rdata : 76'h0};
  wire         selectedVec_0_2 = arrayReg == 6'h29;
  wire         doSpread_2 = selectedVec_0_2 | allReg;
  assign sramDataOut_2 = {28'h0, selectedVec_0_2 ? toSRAM_2_rdata : 76'h0};
  wire         selectedVec_0_3 = arrayReg == 6'h2A;
  wire         doSpread_3 = selectedVec_0_3 | allReg;
  assign sramDataOut_3 = {28'h0, selectedVec_0_3 ? toSRAM_3_rdata : 76'h0};
  ...
  assign sramDataOut_5 = {88'h0, selectedVec_0_5 ? toSRAM_5_rdata : 16'h0};
  wire         selectedVec_0_6 = arrayReg == 6'h2D;
  wire         doSpread_6 = selectedVec_0_6 | allReg;
  assign sramDataOut_6 = {96'h0, selectedVec_0_6 ? toSRAM_6_rdata : 8'h0};
  wire         activated =
    mbist_all | mbist_req
