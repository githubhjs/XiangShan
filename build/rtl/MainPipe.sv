  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s2_valid = _RANDOM[8'h26][13];
        s2_req_miss = _RANDOM[8'h26][14];
        s2_req_miss_id = _RANDOM[8'h26][18:15];
        s2_req_probe = _RANDOM[8'h26][27];
        s2_req_probe_param = _RANDOM[8'h26][29:28];
        s2_req_probe_need_data = _RANDOM[8'h26][30];
        s2_req_source = {_RANDOM[8'h26][31], _RANDOM[8'h27][2:0]};
        s2_req_cmd = _RANDOM[8'h27][7:3];
        s2_req_vaddr = {_RANDOM[8'h27][31:8], _RANDOM[8'h28][25:0]};
        s2_req_addr = {_RANDOM[8'h28][31:26], _RANDOM[8'h29], _RANDOM[8'h2A][9:0]};
        s2_req_store_data =
          {_RANDOM[8'h2A][31:10],
           _RANDOM[8'h2B],
           _RANDOM[8'h2C],
           ...
           _RANDOM[8'h39],
           _RANDOM[8'h3A][9:0]};
        s2_req_store_mask = {_RANDOM[8'h3A][31:10], _RANDOM[8'h3B], _RANDOM[8'h3C][9:0]};
        s2_req_word_idx = _RANDOM[8'h3C][12:10];
        s2_req_amo_data =
          {_RANDOM[8'h3C][31:13],
           _RANDOM[8'h3D],
           _RANDOM[8'h3E],
           _RANDOM[8'h3F],
           _RANDOM[8'h40][12:0]};
        s2_req_amo_mask = _RANDOM[8'h40][28:13];
        s2_req_amo_cmp =
          {_RANDOM[8'h40][31:29],
           _RANDOM[8'h41],
           _RANDOM[8'h42],
           _RANDOM[8'h43],
           _RANDOM[8'h44][28:0]};
        s2_req_pf_source = _RANDOM[8'h45][5:3];
        s2_req_access = _RANDOM[8'h45][6];
        s2_req_id = _RANDOM[8'h45][12:7];
        s2_tag_errors = _RANDOM[8'h45][16:13];
        s2_tag_match = _RANDOM[8'h45][17];
        s2_has_real_tag_eq_way = _RANDOM[8'h45][18];
        s2_tag_ecc_match_way = _RANDOM[8'h45][22:19];
        s2_hit_coh_state = _RANDOM[8'h45][24:23];
        s2_has_permission = _RANDOM[8'h45][25];
        s2_new_hit_coh_state = _RANDOM[8'h45][27:26];
        s2_grow_perm_r = _RANDOM[8'h45][28];
        s2_repl_tag = {_RANDOM[8'h45][31:29], _RANDOM[8'h46], _RANDOM[8'h47][0]};
        s2_repl_coh_state = _RANDOM[8'h47][2:1];
        s2_has_pesudo_inj = _RANDOM[8'h47][6];
        s2_real_tag_has_error_r = {_RANDOM[8'h47][31:7], _RANDOM[8'h48][17:0]};
        s2_need_replacement = _RANDOM[8'h48][18];
        s2_need_eviction = _RANDOM[8'h48][19];
        s2_need_data = _RANDOM[8'h48][20];
        s2_need_tag = _RANDOM[8'h48][21];
        s2_way_en = _RANDOM[8'h48][25:22];
        s2_tag_r = {_RANDOM[8'h48][31:26], _RANDOM[8'h49][29:0]};
        s2_coh_r_state = _RANDOM[8'h49][31:30];
        s2_banked_store_wmask = _RANDOM[8'h4A][7:0];
        s2_flag_error_tl_denied = _RANDOM[8'h4A][8];
        s2_flag_error_tl_corrupt = _RANDOM[8'h4A][9];
        s2_can_go_to_mq_no_data_r = _RANDOM[8'h4A][10];
        s2_can_go_to_mq = _RANDOM[8'h4A][11];
        io_data_readline_can_go_last_REG = _RANDOM[8'h4A][13];
        s3_valid = _RANDOM[8'h4A][14];
        s3_req_miss = _RANDOM[8'h4A][15];
        s3_req_miss_id = _RANDOM[8'h4A][19:16];
        s3_req_probe = _RANDOM[8'h4A][28];
        s3_req_probe_param = _RANDOM[8'h4A][30:29];
        s3_req_probe_need_data = _RANDOM[8'h4A][31];
        s3_req_source = _RANDOM[8'h4B][3:0];
        s3_req_cmd = _RANDOM[8'h4B][8:4];
        s3_req_vaddr = {_RANDOM[8'h4B][31:9], _RANDOM[8'h4C][26:0]};
        s3_req_addr = {_RANDOM[8'h4C][31:27], _RANDOM[8'h4D], _RANDOM[8'h4E][10:0]};
        s3_req_word_idx = _RANDOM[8'h60][13:11];
        s3_req_amo_data =
          {_RANDOM[8'h60][31:14],
           _RANDOM[8'h61],
           _RANDOM[8'h62],
           _RANDOM[8'h63],
           _RANDOM[8'h64][13:0]};
        s3_req_amo_mask = _RANDOM[8'h64][29:14];
        s3_req_amo_cmp =
          {_RANDOM[8'h64][31:30],
           _RANDOM[8'h65],
           _RANDOM[8'h66],
           _RANDOM[8'h67],
           _RANDOM[8'h68][29:0]};
        s3_req_pf_source = _RANDOM[8'h69][6:4];
        s3_req_access = _RANDOM[8'h69][7];
        s3_req_id = _RANDOM[8'h69][13:8];
        s3_miss_param = _RANDOM[8'h69][15:14];
        s3_tag = {_RANDOM[8'h69][31:17], _RANDOM[8'h6A][20:0]};
        s3_tag_match = _RANDOM[8'h6A][21];
        s3_coh_state = _RANDOM[8'h6A][23:22];
        s3_hit = _RANDOM[8'h6A][24];
        s3_amo_hit = _RANDOM[8'h6A][25];
        s3_store_hit = _RANDOM[8'h6A][26];
        s3_hit_coh_state = _RANDOM[8'h6A][28:27];
        s3_new_hit_coh_state = _RANDOM[8'h6A][30:29];
        s3_way_en = {_RANDOM[8'h6A][31], _RANDOM[8'h6B][2:0]};
        s3_banked_store_wmask = _RANDOM[8'h6B][10:3];
        s3_idx = _RANDOM[8'h6B][18:11];
        s3_store_data_merged_without_cache_0 =
          {_RANDOM[8'h6B][31:19], _RANDOM[8'h6C], _RANDOM[8'h6D][18:0]};
        s3_store_data_merged_without_cache_1 =
          {_RANDOM[8'h6D][31:19], _RANDOM[8'h6E], _RANDOM[8'h6F][18:0]};
        s3_store_data_merged_without_cache_2 =
          {_RANDOM[8'h6F][31:19], _RANDOM[8'h70], _RANDOM[8'h71][18:0]};
        s3_store_data_merged_without_cache_3 =
          {_RANDOM[8'h71][31:19], _RANDOM[8'h72], _RANDOM[8'h73][18:0]};
        s3_store_data_merged_without_cache_4 =
          {_RANDOM[8'h73][31:19], _RANDOM[8'h74], _RANDOM[8'h75][18:0]};
        s3_store_data_merged_without_cache_5 =
          {_RANDOM[8'h75][31:19], _RANDOM[8'h76], _RANDOM[8'h77][18:0]};
        s3_store_data_merged_without_cache_6 =
          {_RANDOM[8'h77][31:19], _RANDOM[8'h78], _RANDOM[8'h79][18:0]};
        s3_store_data_merged_without_cache_7 =
          {_RANDOM[8'h79][31:19], _RANDOM[8'h7A], _RANDOM[8'h7B][18:0]};
        s3_merge_mask_0 = _RANDOM[8'h7B][26:19];
        s3_merge_mask_1 = {_RANDOM[8'h7B][31:27], _RANDOM[8'h7C][2:0]};
        s3_merge_mask_2 = _RANDOM[8'h7C][10:3];
        s3_merge_mask_3 = _RANDOM[8'h7C][18:11];
        s3_merge_mask_4 = _RANDOM[8'h7C][26:19];
        s3_merge_mask_5 = {_RANDOM[8'h7C][31:27], _RANDOM[8'h7D][2:0]};
        s3_merge_mask_6 = _RANDOM[8'h7D][10:3];
        s3_merge_mask_7 = _RANDOM[8'h7D][18:11];
        s3_refill_latency = {_RANDOM[8'h7D][31:19], _RANDOM[8'h7E][2:0]};
        s3_need_replacement = _RANDOM[8'h7E][3];
        s3_tag_error_beu = _RANDOM[8'h7E][4];
        s3_tag_error_wb = _RANDOM[8'h7E][5];
        s3_data_error_beu_last_REG = _RANDOM[8'h7E][6];
        s3_data_error_beu_r = _RANDOM[8'h7E][7];
        s3_data_error_wb_r = _RANDOM[8'h7E][8];
        s3_l2_error_wb_tl_denied = _RANDOM[8'h7E][11];
        s3_l2_error_wb_tl_corrupt = _RANDOM[8'h7E][12];
        s3_flag_error_beu_tl_denied = _RANDOM[8'h7E][13];
        s3_flag_error_beu_tl_corrupt = _RANDOM[8'h7E][14];
        s3_error_beu_r = _RANDOM[8'h7E][15];
        s3_error_paddr_beu_r = {_RANDOM[8'h7E][31:17], _RANDOM[8'h7F], _RANDOM[8'h80][0]};
        lrsc_count = _RANDOM[8'h82][6:1];
        lrsc_addr = {_RANDOM[8'h82][31:7], _RANDOM[8'h83][22:0]};
        s3_s_amoalu = _RANDOM[8'h83][23];
        io_block_lr_last_REG = _RANDOM[8'h83][24];
        s3_amo_data_merged_reg_0 =
          {_RANDOM[8'h83][31:25], _RANDOM[8'h84], _RANDOM[8'h85][24:0]};
        s3_amo_data_merged_reg_1 =
          {_RANDOM[8'h85][31:25], _RANDOM[8'h86], _RANDOM[8'h87][24:0]};
        s3_amo_data_merged_reg_2 =
          {_RANDOM[8'h87][31:25], _RANDOM[8'h88], _RANDOM[8'h89][24:0]};
        s3_amo_data_merged_reg_3 =
          {_RANDOM[8'h89][31:25], _RANDOM[8'h8A], _RANDOM[8'h8B][24:0]};
        s3_amo_data_merged_reg_4 =
          {_RANDOM[8'h8B][31:25], _RANDOM[8'h8C], _RANDOM[8'h8D][24:0]};
        s3_amo_data_merged_reg_5 =
          {_RANDOM[8'h8D][31:25], _RANDOM[8'h8E], _RANDOM[8'h8F][24:0]};
        s3_amo_data_merged_reg_6 =
          {_RANDOM[8'h8F][31:25], _RANDOM[8'h90], _RANDOM[8'h91][24:0]};
        s3_amo_data_merged_reg_7 =
          {_RANDOM[8'h91][31:25], _RANDOM[8'h92], _RANDOM[8'h93][24:0]};
        s2_isStore = _RANDOM[8'h93][25];
        s2_isAMO = _RANDOM[8'h93][26];
        io_replace_access_valid_last_REG = _RANDOM[8'h93][30];
        io_sms_agt_evict_req_valid_last_REG = _RANDOM[8'h94][0];
        io_sms_agt_evict_req_bits_vaddr_r = {_RANDOM[8'h94][31:1], _RANDOM[8'h95][18:0]};
        io_status_dup_0_s1_bits_set_r = _RANDOM[8'h95][26:19];
        io_status_dup_0_s2_bits_set_r = {_RANDOM[8'h95][31:28], _RANDOM[8'h96][3:0]};
        io_status_dup_0_s3_bits_set_r = _RANDOM[8'h96][12:5];
        io_status_dup_0_s3_bits_way_en_r = _RANDOM[8'h96][16:13];
        io_status_dup_1_s1_bits_set_r = _RANDOM[8'h96][24:17];
        io_status_dup_1_s2_bits_set_r = {_RANDOM[8'h96][31:26], _RANDOM[8'h97][1:0]};
        io_status_dup_1_s3_bits_set_r = _RANDOM[8'h97][10:3];
        io_status_dup_1_s3_bits_way_en_r = _RANDOM[8'h97][14:11];
        io_status_dup_2_s1_bits_set_r = _RANDOM[8'h97][22:15];
        io_status_dup_2_s2_bits_set_r = _RANDOM[8'h97][31:24];
        io_status_dup_2_s3_bits_set_r = _RANDOM[8'h98][8:1];
        io_status_dup_2_s3_bits_way_en_r = _RANDOM[8'h98][12:9];
        io_status_dup_3_s1_bits_set_r = _RANDOM[8'h98][20:13];
        io_status_dup_3_s2_bits_set_r = _RANDOM[8'h98][29:22];
        io_status_dup_3_s3_bits_set_r = {_RANDOM[8'h98][31], _RANDOM[8'h99][6:0]};
        io_status_dup_3_s3_bits_way_en_r = _RANDOM[8'h99][10:7];
        io_status_dup_4_s1_bits_set_r = _RANDOM[8'h99][18:11];
        io_status_dup_4_s2_bits_set_r = _RANDOM[8'h99][27:20];
        io_status_dup_4_s3_bits_set_r = {_RANDOM[8'h99][31:29], _RANDOM[8'h9A][4:0]};
        io_status_dup_4_s3_bits_way_en_r = _RANDOM[8'h9A][8:5];
        io_status_dup_5_s1_bits_set_r = _RANDOM[8'h9A][16:9];
        io_status_dup_5_s2_bits_set_r = _RANDOM[8'h9A][25:18];
        io_status_dup_5_s3_bits_set_r = {_RANDOM[8'h9A][31:27], _RANDOM[8'h9B][2:0]};
        io_status_dup_5_s3_bits_way_en_r = _RANDOM[8'h9B][6:3];
        io_status_dup_6_s1_bits_set_r = _RANDOM[8'h9B][14:7];
        io_status_dup_6_s2_bits_set_r = _RANDOM[8'h9B][23:16];
        io_status_dup_6_s3_bits_set_r = {_RANDOM[8'h9B][31:25], _RANDOM[8'h9C][0]};
        io_status_dup_6_s3_bits_way_en_r = _RANDOM[8'h9C][4:1];
        io_status_dup_7_s1_bits_set_r = _RANDOM[8'h9C][12:5];
        io_status_dup_7_s2_bits_set_r = _RANDOM[8'h9C][21:14];
        io_status_dup_7_s3_bits_set_r = _RANDOM[8'h9C][30:23];
        io_status_dup_7_s3_bits_way_en_r = {_RANDOM[8'h9C][31], _RANDOM[8'h9D][2:0]};
        io_status_dup_8_s1_bits_set_r = _RANDOM[8'h9D][10:3];
        io_status_dup_8_s2_bits_set_r = _RANDOM[8'h9D][19:12];
        io_status_dup_8_s3_bits_set_r = _RANDOM[8'h9D][28:21];
        io_status_dup_8_s3_bits_way_en_r = {_RANDOM[8'h9D][31:29], _RANDOM[8'h9E][0]};
        io_status_dup_9_s1_bits_set_r = _RANDOM[8'h9E][8:1];
        io_status_dup_9_s2_bits_set_r = _RANDOM[8'h9E][17:10];
        io_status_dup_9_s3_bits_set_r = _RANDOM[8'h9E][26:19];
        io_status_dup_9_s3_bits_way_en_r = _RANDOM[8'h9E][30:27];
        io_status_dup_10_s1_bits_set_r = {_RANDOM[8'h9E][31], _RANDOM[8'h9F][6:0]};
        io_status_dup_10_s2_bits_set_r = _RANDOM[8'h9F][15:8];
        io_status_dup_10_s3_bits_set_r = _RANDOM[8'h9F][24:17];
        io_status_dup_10_s3_bits_way_en_r = _RANDOM[8'h9F][28:25];
        io_status_dup_11_s1_bits_set_r = {_RANDOM[8'h9F][31:29], _RANDOM[8'hA0][4:0]};
        io_status_dup_11_s2_bits_set_r = _RANDOM[8'hA0][13:6];
        io_status_dup_11_s3_bits_set_r = _RANDOM[8'hA0][22:15];
        io_status_dup_11_s3_bits_way_en_r = _RANDOM[8'hA0][26:23];
        io_status_dup_12_s1_bits_set_r = {_RANDOM[8'hA0][31:27], _RANDOM[8'hA1][2:0]};
        io_status_dup_12_s2_bits_set_r = _RANDOM[8'hA1][11:4];
        io_status_dup_12_s3_bits_set_r = _RANDOM[8'hA1][20:13];
        io_status_dup_12_s3_bits_way_en_r = _RANDOM[8'hA1][24:21];
        io_status_dup_13_s1_bits_set_r = {_RANDOM[8'hA1][31:25], _RANDOM[8'hA2][0]};
        io_status_dup_13_s2_bits_set_r = _RANDOM[8'hA2][9:2];
        io_status_dup_13_s3_bits_set_r = _RANDOM[8'hA2][18:11];
        io_status_dup_13_s3_bits_way_en_r = _RANDOM[8'hA2][22:19];
        io_status_dup_14_s1_bits_set_r = _RANDOM[8'hA2][30:23];
        io_status_dup_14_s2_bits_set_r = _RANDOM[8'hA3][7:0];
        io_status_dup_14_s3_bits_set_r = _RANDOM[8'hA3][16:9];
        io_status_dup_14_s3_bits_way_en_r = _RANDOM[8'hA3][20:17];
        io_status_dup_15_s1_bits_set_r = _RANDOM[8'hA3][28:21];
        io_status_dup_15_s2_bits_set_r = {_RANDOM[8'hA3][31:30], _RANDOM[8'hA4][5:0]};
        io_status_dup_15_s3_bits_set_r = _RANDOM[8'hA4][14:7];
        io_status_dup_15_s3_bits_way_en_r = _RANDOM[8'hA4][18:15];
        io_status_dup_16_s1_bits_set_r = _RANDOM[8'hA4][26:19];
        io_status_dup_16_s2_bits_set_r = {_RANDOM[8'hA4][31:28], _RANDOM[8'hA5][3:0]};
        io_status_dup_16_s3_bits_set_r = _RANDOM[8'hA5][12:5];
        io_status_dup_16_s3_bits_way_en_r = _RANDOM[8'hA5][16:13];
        io_status_dup_17_s1_bits_set_r = _RANDOM[8'hA5][24:17];
        io_status_dup_17_s2_bits_set_r = {_RANDOM[8'hA5][31:26], _RANDOM[8'hA6][1:0]};
        io_status_dup_17_s3_bits_set_r = _RANDOM[8'hA6][10:3];
        io_status_dup_17_s3_bits_way_en_r = _RANDOM[8'hA6][14:11];
        io_status_dup_18_s1_bits_set_r = _RANDOM[8'hA6][22:15];
        io_status_dup_18_s2_bits_set_r = _RANDOM[8'hA6][31:24];
        io_status_dup_18_s3_bits_set_r = _RANDOM[8'hA7][8:1];
        io_status_dup_18_s3_bits_way_en_r = _RANDOM[8'hA7][12:9];
        io_status_dup_19_s1_bits_set_r = _RANDOM[8'hA7][20:13];
        io_status_dup_19_s2_bits_set_r = _RANDOM[8'hA7][29:22];
        io_status_dup_19_s3_bits_set_r = {_RANDOM[8'hA7][31], _RANDOM[8'hA8][6:0]};
        io_status_dup_19_s3_bits_way_en_r = _RANDOM[8'hA8][10:7];
        io_status_dup_20_s1_bits_set_r = _RANDOM[8'hA8][18:11];
        io_status_dup_20_s2_bits_set_r = _RANDOM[8'hA8][27:20];
        io_status_dup_20_s3_bits_set_r = {_RANDOM[8'hA8][31:29], _RANDOM[8'hA9][4:0]};
        io_status_dup_20_s3_bits_way_en_r = _RANDOM[8'hA9][8:5];
        io_status_dup_21_s1_bits_set_r = _RANDOM[8'hA9][16:9];
        io_status_dup_21_s2_bits_set_r = _RANDOM[8'hA9][25:18];
        io_status_dup_21_s3_bits_set_r = {_RANDOM[8'hA9][31:27], _RANDOM[8'hAA][2:0]};
        io_status_dup_21_s3_bits_way_en_r = _RANDOM[8'hAA][6:3];
        io_status_dup_22_s1_bits_set_r = _RANDOM[8'hAA][14:7];
        io_status_dup_22_s2_bits_set_r = _RANDOM[8'hAA][23:16];
        io_status_dup_22_s3_bits_set_r = {_RANDOM[8'hAA][31:25], _RANDOM[8'hAB][0]};
        io_status_dup_22_s3_bits_way_en_r = _RANDOM[8'hAB][4:1];
        io_status_dup_23_s1_bits_set_r = _RANDOM[8'hAB][12:5];
        io_status_dup_23_s2_bits_set_r = _RANDOM[8'hAB][21:14];
        io_status_dup_23_s3_bits_set_r = _RANDOM[8'hAB][30:23];
        io_status_dup_23_s3_bits_way_en_r = {_RANDOM[8'hAB][31], _RANDOM[8'hAC][2:0]};
        io_mainpipe_info_s3_refill_resp_REG = _RANDOM[8'hAC][3];
        io_error_valid_last_REG = _RANDOM[8'hAC][4];
        io_error_bits_report_to_beu_REG = _RANDOM[8'hAC][5];
        io_perf_0_value_REG = _RANDOM[8'hAC][10];
        io_perf_0_value_REG_1 = _RANDOM[8'hAC][11];
        io_perf_1_value_REG = _RANDOM[8'hAC][12];
        io_perf_1_value_REG_1 = _RANDOM[8'hAC][13];
        io_perf_2_value_REG = _RANDOM[8'hAC][14];
        io_perf_2_value_REG_1 = _RANDOM[8'hAC][15];
        io_perf_3_value_REG = _RANDOM[8'hAC][18:16];
        io_perf_3_value_REG_1 = _RANDOM[8'hAC][21:19];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        s1_valid = 1'h0;
        last_REG = 1'h0;
