...
module Uncache(
  ...
  reg               noPending_15;
  reg               do_uarch_drain;
  wire              _q0_canSentVec_T_135 = uState == 2'h0;
  ...
  wire              q0_canSentVec_0 =
    (io_enableOutstanding | _q0_canSentVec_T_135) & states_0_valid & ~states_0_inflight
    & ~states_0_waitSame & ~states_0_waitReturn;
  wire              q0_canSentVec_1 =
    (io_enableOutstanding | _q0_canSentVec_T_135) & states_1_valid & ~states_1_inflight
    & ~states_1_waitSame & ~states_1_waitReturn;
  wire              q0_canSentVec_2 =
    (io_enableOutstanding | _q0_canSentVec_T_135) & states_2_valid & ~states_2_inflight
    & ~states_2_waitSame & ~states_2_waitReturn;
  wire              q0_canSentVec_3 =
    (io_enableOutstanding | _q0_canSentVec_T_135) & states_3_valid & ~states_3_inflight
    & ~states_3_waitSame & ~states_3_waitReturn;
  wire              q0_canSentVec_4 =
    (io_enableOutstanding | _q0_canSentVec_T_135) & states_4_valid & ~states_4_inflight
    & ~states_4_waitSame & ~states_4_waitReturn;
  wire              q0_canSentVec_5 =
    (io_enableOutstanding | _q0_canSentVec_T_135) & states_5_valid & ~states_5_inflight
    & ~states_5_waitSame & ~states_5_waitReturn;
  wire              q0_canSentVec_6 =
    (io_enableOutstanding | _q0_canSentVec_T_135) & states_6_valid & ~states_6_inflight
    & ~states_6_waitSame & ~states_6_waitReturn;
  wire              q0_canSentVec_7 =
    (io_enableOutstanding | _q0_canSentVec_T_135) & states_7_valid & ~states_7_inflight
    & ~states_7_waitSame & ~states_7_waitReturn;
  wire              q0_canSentVec_8 =
    (io_enableOutstanding | _q0_canSentVec_T_135) & states_8_valid & ~states_8_inflight
    & ~states_8_waitSame & ~states_8_waitReturn;
  wire              q0_canSentVec_9 =
    (io_enableOutstanding | _q0_canSentVec_T_135) & states_9_valid & ~states_9_inflight
    & ~states_9_waitSame & ~states_9_waitReturn;
  wire              q0_canSentVec_10 =
    (io_enableOutstanding | _q0_canSentVec_T_135) & states_10_valid & ~states_10_inflight
    & ~states_10_waitSame & ~states_10_waitReturn;
  wire              q0_canSentVec_11 =
    (io_enableOutstanding | _q0_canSentVec_T_135) & states_11_valid & ~states_11_inflight
    & ~states_11_waitSame & ~states_11_waitReturn;
  wire              q0_canSentVec_12 =
    (io_enableOutstanding | _q0_canSentVec_T_135) & states_12_valid & ~states_12_inflight
    & ~states_12_waitSame & ~states_12_waitReturn;
  wire              q0_canSentVec_13 =
    (io_enableOutstanding | _q0_canSentVec_T_135) & states_13_valid & ~states_13_inflight
    & ~states_13_waitSame & ~states_13_waitReturn;
  wire              q0_canSentVec_14 =
    (io_enableOutstanding | _q0_canSentVec_T_135) & states_14_valid & ~states_14_inflight
  ...
  assign q0_canSent =
    ...
    | (io_enableOutstanding | _q0_canSentVec_T_135) & states_15_valid
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      states_0_inflight <=
        _GEN_102 ? ~(_GEN_167 | _GEN_50) & _GEN_104 : ~_GEN_50 & _GEN_104;
      states_0_waitSame <=
        _GEN_102 ? ~(_GEN_167 | _GEN_151) & _GEN_135 : ~_GEN_151 & _GEN_135;
      states_0_waitReturn <= ~_GEN_168 & (_GEN_50 | states_0_waitReturn);
      states_1_valid <= ~_GEN_170 & (~_GEN & _GEN_7 | states_1_valid);
      states_1_inflight <=
        _GEN_102 ? ~(_GEN_169 | _GEN_51) & _GEN_106 : ~_GEN_51 & _GEN_106;
      states_1_waitSame <=
        _GEN_102 ? ~(_GEN_169 | _GEN_152) & _GEN_136 : ~_GEN_152 & _GEN_136;
      states_1_waitReturn <= ~_GEN_170 & (_GEN_51 | states_1_waitReturn);
      states_2_valid <= ~_GEN_172 & (~_GEN & _GEN_9 | states_2_valid);
      states_2_inflight <=
        _GEN_102 ? ~(_GEN_171 | _GEN_52) & _GEN_108 : ~_GEN_52 & _GEN_108;
      states_2_waitSame <=
        _GEN_102 ? ~(_GEN_171 | _GEN_153) & _GEN_137 : ~_GEN_153 & _GEN_137;
      states_2_waitReturn <= ~_GEN_172 & (_GEN_52 | states_2_waitReturn);
      states_3_valid <= ~_GEN_174 & (~_GEN & _GEN_11 | states_3_valid);
      states_3_inflight <=
        _GEN_102 ? ~(_GEN_173 | _GEN_53) & _GEN_110 : ~_GEN_53 & _GEN_110;
      states_3_waitSame <=
        _GEN_102 ? ~(_GEN_173 | _GEN_154) & _GEN_138 : ~_GEN_154 & _GEN_138;
      states_3_waitReturn <= ~_GEN_174 & (_GEN_53 | states_3_waitReturn);
      states_4_valid <= ~_GEN_176 & (~_GEN & _GEN_13 | states_4_valid);
      states_4_inflight <=
        _GEN_102 ? ~(_GEN_175 | _GEN_54) & _GEN_112 : ~_GEN_54 & _GEN_112;
      states_4_waitSame <=
        _GEN_102 ? ~(_GEN_175 | _GEN_155) & _GEN_139 : ~_GEN_155 & _GEN_139;
      states_4_waitReturn <= ~_GEN_176 & (_GEN_54 | states_4_waitReturn);
      states_5_valid <= ~_GEN_178 & (~_GEN & _GEN_15 | states_5_valid);
      states_5_inflight <=
        _GEN_102 ? ~(_GEN_177 | _GEN_55) & _GEN_114 : ~_GEN_55 & _GEN_114;
      states_5_waitSame <=
        _GEN_102 ? ~(_GEN_177 | _GEN_156) & _GEN_140 : ~_GEN_156 & _GEN_140;
      states_5_waitReturn <= ~_GEN_178 & (_GEN_55 | states_5_waitReturn);
      states_6_valid <= ~_GEN_180 & (~_GEN & _GEN_17 | states_6_valid);
      states_6_inflight <=
        _GEN_102 ? ~(_GEN_179 | _GEN_56) & _GEN_116 : ~_GEN_56 & _GEN_116;
      states_6_waitSame <=
        _GEN_102 ? ~(_GEN_179 | _GEN_157) & _GEN_141 : ~_GEN_157 & _GEN_141;
      states_6_waitReturn <= ~_GEN_180 & (_GEN_56 | states_6_waitReturn);
      states_7_valid <= ~_GEN_182 & (~_GEN & _GEN_19 | states_7_valid);
      states_7_inflight <=
        _GEN_102 ? ~(_GEN_181 | _GEN_57) & _GEN_118 : ~_GEN_57 & _GEN_118;
      states_7_waitSame <=
        _GEN_102 ? ~(_GEN_181 | _GEN_158) & _GEN_142 : ~_GEN_158 & _GEN_142;
      states_7_waitReturn <= ~_GEN_182 & (_GEN_57 | states_7_waitReturn);
      states_8_valid <= ~_GEN_184 & (~_GEN & _GEN_21 | states_8_valid);
      states_8_inflight <=
        _GEN_102 ? ~(_GEN_183 | _GEN_58) & _GEN_120 : ~_GEN_58 & _GEN_120;
      states_8_waitSame <=
        _GEN_102 ? ~(_GEN_183 | _GEN_159) & _GEN_143 : ~_GEN_159 & _GEN_143;
      states_8_waitReturn <= ~_GEN_184 & (_GEN_58 | states_8_waitReturn);
      states_9_valid <= ~_GEN_186 & (~_GEN & _GEN_23 | states_9_valid);
      states_9_inflight <=
        _GEN_102 ? ~(_GEN_185 | _GEN_59) & _GEN_122 : ~_GEN_59 & _GEN_122;
      states_9_waitSame <=
        _GEN_102 ? ~(_GEN_185 | _GEN_160) & _GEN_144 : ~_GEN_160 & _GEN_144;
      states_9_waitReturn <= ~_GEN_186 & (_GEN_59 | states_9_waitReturn);
      states_10_valid <= ~_GEN_188 & (~_GEN & _GEN_25 | states_10_valid);
      states_10_inflight <=
        _GEN_102 ? ~(_GEN_187 | _GEN_60) & _GEN_124 : ~_GEN_60 & _GEN_124;
      states_10_waitSame <=
        _GEN_102 ? ~(_GEN_187 | _GEN_161) & _GEN_145 : ~_GEN_161 & _GEN_145;
      states_10_waitReturn <= ~_GEN_188 & (_GEN_60 | states_10_waitReturn);
      states_11_valid <= ~_GEN_190 & (~_GEN & _GEN_27 | states_11_valid);
      states_11_inflight <=
        _GEN_102 ? ~(_GEN_189 | _GEN_61) & _GEN_126 : ~_GEN_61 & _GEN_126;
      states_11_waitSame <=
        _GEN_102 ? ~(_GEN_189 | _GEN_162) & _GEN_146 : ~_GEN_162 & _GEN_146;
      states_11_waitReturn <= ~_GEN_190 & (_GEN_61 | states_11_waitReturn);
      states_12_valid <= ~_GEN_192 & (~_GEN & _GEN_29 | states_12_valid);
      states_12_inflight <=
        _GEN_102 ? ~(_GEN_191 | _GEN_62) & _GEN_128 : ~_GEN_62 & _GEN_128;
      states_12_waitSame <=
        _GEN_102 ? ~(_GEN_191 | _GEN_163) & _GEN_147 : ~_GEN_163 & _GEN_147;
      states_12_waitReturn <= ~_GEN_192 & (_GEN_62 | states_12_waitReturn);
      states_13_valid <= ~_GEN_194 & (~_GEN & _GEN_31 | states_13_valid);
      states_13_inflight <=
        _GEN_102 ? ~(_GEN_193 | _GEN_63) & _GEN_130 : ~_GEN_63 & _GEN_130;
      states_13_waitSame <=
        _GEN_102 ? ~(_GEN_193 | _GEN_164) & _GEN_148 : ~_GEN_164 & _GEN_148;
      states_13_waitReturn <= ~_GEN_194 & (_GEN_63 | states_13_waitReturn);
      states_14_valid <= ~_GEN_196 & (~_GEN & _GEN_33 | states_14_valid);
      states_14_inflight <=
        _GEN_102 ? ~(_GEN_195 | _GEN_64) & _GEN_132 : ~_GEN_64 & _GEN_132;
      states_14_waitSame <=
        _GEN_102 ? ~(_GEN_195 | _GEN_165) & _GEN_149 : ~_GEN_165 & _GEN_149;
      states_14_waitReturn <= ~_GEN_196 & (_GEN_64 | states_14_waitReturn);
      states_15_valid <= ~_GEN_197 & (~_GEN & _GEN_34 | states_15_valid);
      states_15_inflight <=
        _GEN_102 ? ~((&r0_canSentIdx) | _GEN_65) & _GEN_134 : ~_GEN_65 & _GEN_134;
      states_15_waitSame <=
        _GEN_102 ? ~((&r0_canSentIdx) | _GEN_166) & _GEN_150 : ~_GEN_166 & _GEN_150;
      states_15_waitReturn <= ~_GEN_197 & (_GEN_65 | states_15_waitReturn);
      if (_q0_canSentVec_T_135) begin
  ...
  assign io_forward_1_forwardMask_0 = _f1_fwdMask_T_37[0] & f1_fwdValid_1;
  assign io_forward_1_forwardMask_1 = _f1_fwdMask_T_37[1] & f1_fwdValid_1;
  assign io_forward_1_forwardMask_2 = _f1_fwdMask_T_37[2] & f1_fwdValid_1;
  assign io_forward_1_forwardMask_3 = _f1_fwdMask_T_37[3] & f1_fwdValid_1;
  assign io_forward_1_forwardMask_4 = _f1_fwdMask_T_37[4] & f1_fwdValid_1;
  assign io_forward_1_forwardMask_5 = _f1_fwdMask_T_37[5] & f1_fwdValid_1;
  assign io_forward_1_forwardMask_6 = _f1_fwdMask_T_37[6] & f1_fwdValid_1;
  assign io_forward_1_forwardMask_7 = _f1_fwdMask_T_37[7] & f1_fwdValid_1;
  assign io_forward_1_forwardMask_8 = _f1_fwdMask_T_37[8] & f1_fwdValid_1;
  assign io_forward_1_forwardMask_9 = _f1_fwdMask_T_37[9] & f1_fwdValid_1;
  assign io_forward_1_forwardMask_10 = _f1_fwdMask_T_37[10] & f1_fwdValid_1;
  assign io_forward_1_forwardMask_11 = _f1_fwdMask_T_37[11] & f1_fwdValid_1;
  assign io_forward_1_forwardMask_12 = _f1_fwdMask_T_37[12] & f1_fwdValid_1;
  assign io_forward_1_forwardMask_13 = _f1_fwdMask_T_37[13] & f1_fwdValid_1;
  assign io_forward_1_forwardMask_14 = _f1_fwdMask_T_37[14] & f1_fwdValid_1;
  assign io_forward_1_forwardMask_15 = _f1_fwdMask_T_37[15] & f1_fwdValid_1;
  ...
  assign io_forward_2_forwardMask_0 = _f1_fwdMask_T_72[0] & f1_fwdValid_2;
  assign io_forward_2_forwardMask_1 = _f1_fwdMask_T_72[1] & f1_fwdValid_2;
  assign io_forward_2_forwardMask_2 = _f1_fwdMask_T_72[2] & f1_fwdValid_2;
  assign io_forward_2_forwardMask_3 = _f1_fwdMask_T_72[3] & f1_fwdValid_2;
  assign io_forward_2_forwardMask_4 = _f1_fwdMask_T_72[4] & f1_fwdValid_2;
  assign io_forward_2_forwardMask_5 = _f1_fwdMask_T_72[5] & f1_fwdValid_2;
  assign io_forward_2_forwardMask_6 = _f1_fwdMask_T_72[6] & f1_fwdValid_2;
  assign io_forward_2_forwardMask_7 = _f1_fwdMask_T_72[7] & f1_fwdValid_2;
  assign io_forward_2_forwardMask_8 = _f1_fwdMask_T_72[8] & f1_fwdValid_2;
  assign io_forward_2_forwardMask_9 = _f1_fwdMask_T_72[9] & f1_fwdValid_2;
  assign io_forward_2_forwardMask_10 = _f1_fwdMask_T_72[10] & f1_fwdValid_2;
  assign io_forward_2_forwardMask_11 = _f1_fwdMask_T_72[11] & f1_fwdValid_2;
  assign io_forward_2_forwardMask_12 = _f1_fwdMask_T_72[12] & f1_fwdValid_2;
  assign io_forward_2_forwardMask_13 = _f1_fwdMask_T_72[13] & f1_fwdValid_2;
  assign io_forward_2_forwardMask_14 = _f1_fwdMask_T_72[14] & f1_fwdValid_2;
  assign io_forward_2_forwardMask_15 = _f1_fwdMask_T_72[15] & f1_fwdValid_2;
