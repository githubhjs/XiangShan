...
module Queue4_HintQueueEntry(
  ...
  ram_4x11 ram_ext (
    ...
    .W0_en   (do_enq),
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_source, io_enq_bits_opcode, io_enq_bits_isKeyword})
  );
  assign io_deq_valid = io_deq_valid_0;
  assign io_deq_bits_source = empty ? io_enq_bits_source : _ram_ext_R0_data[10:4];
  assign io_deq_bits_opcode = empty ? io_enq_bits_opcode : _ram_ext_R0_data[3:1];
  assign io_deq_bits_isKeyword = empty ? io_enq_bits_isKeyword : _ram_ext_R0_data[0];
endmodule
