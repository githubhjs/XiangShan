  ...
  wire        task_s1_bits_isKeyword =
    mshr_task_s1_valid
      ...
      : _chnl_task_s1_bits_T
          ...
          : _chnl_task_s1_bits_T_1 ? io_sinkB_bits_isKeyword : io_sinkA_bits_isKeyword;
  ...
  wire [6:0]  task_s1_bits_sourceId =
    mshr_task_s1_valid
      ...
      : _chnl_task_s1_bits_T
          ...
          : _chnl_task_s1_bits_T_1 ? io_sinkB_bits_sourceId : io_sinkA_bits_sourceId;
  ...
  wire        task_s1_bits_aliasTask =
    mshr_task_s1_valid
      ...
      : _chnl_task_s1_bits_T
          ...
          : _chnl_task_s1_bits_T_1 ? io_sinkB_bits_aliasTask : io_sinkA_bits_aliasTask;
  ...
  wire        task_s1_bits_mshrRetry =
    mshr_task_s1_valid
      ...
      : _chnl_task_s1_bits_T
          ...
          : _chnl_task_s1_bits_T_1 ? io_sinkB_bits_mshrRetry : io_sinkA_bits_mshrRetry;
  ...
  wire        task_s1_bits_fromL2pft =
    mshr_task_s1_valid
      ...
      : _chnl_task_s1_bits_T
          ...
          : _chnl_task_s1_bits_T_1 ? io_sinkB_bits_fromL2pft : io_sinkA_bits_fromL2pft;
  wire        task_s1_bits_needHint =
    mshr_task_s1_valid
      ? mshr_task_s1_bits_needHint
      : _chnl_task_s1_bits_T
          ? io_sinkC_bits_needHint
          : _chnl_task_s1_bits_T_1 ? io_sinkB_bits_needHint : io_sinkA_bits_needHint;
  ...
  wire        task_s1_bits_meta_dirty =
    mshr_task_s1_valid
      ...
      : _chnl_task_s1_bits_T
          ...
          : _chnl_task_s1_bits_T_1 ? io_sinkB_bits_meta_dirty : io_sinkA_bits_meta_dirty;
  wire [1:0]  task_s1_bits_meta_state =
    mshr_task_s1_valid
      ? mshr_task_s1_bits_meta_state
      : _chnl_task_s1_bits_T
          ? io_sinkC_bits_meta_state
          : _chnl_task_s1_bits_T_1 ? io_sinkB_bits_meta_state : io_sinkA_bits_meta_state;
  ...
  wire [1:0]  task_s1_bits_meta_alias =
    mshr_task_s1_valid
      ...
      : _chnl_task_s1_bits_T
          ...
          : _chnl_task_s1_bits_T_1 ? io_sinkB_bits_meta_alias : io_sinkA_bits_meta_alias;
  ...
  wire        task_s1_bits_replTask =
    mshr_task_s1_valid
      ...
      : _chnl_task_s1_bits_T
          ...
          : _chnl_task_s1_bits_T_1 ? io_sinkB_bits_replTask : io_sinkA_bits_replTask;
