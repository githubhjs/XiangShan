  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        ld_in_reordered_res_0_1_0_bits_uop_robIdx_flag = _RANDOM[10'h2F][19];
        ld_in_reordered_res_0_1_0_bits_uop_robIdx_value = _RANDOM[10'h2F][28:20];
        ld_in_reordered_res_0_1_0_bits_vaddr =
          {_RANDOM[10'h45][31:20], _RANDOM[10'h46], _RANDOM[10'h47][5:0]};
        ld_in_reordered_res_0_1_1_valid = _RANDOM[10'h5C][23];
        ld_in_reordered_res_0_1_1_bits_uop_pc =
          {_RANDOM[10'h5D][31:24], _RANDOM[10'h5E], _RANDOM[10'h5F][9:0]};
        ...
        ld_in_reordered_res_0_1_1_bits_vaddr =
          {_RANDOM[10'h85][31:17], _RANDOM[10'h86], _RANDOM[10'h87][2:0]};
        ld_in_reordered_res_0_1_2_valid = _RANDOM[10'h9C][20];
        ld_in_reordered_res_0_1_2_bits_uop_pc =
          {_RANDOM[10'h9D][31:21], _RANDOM[10'h9E], _RANDOM[10'h9F][6:0]};
        ld_in_reordered_res_0_1_2_bits_uop_robIdx_flag = _RANDOM[10'hAF][13];
        ld_in_reordered_res_0_1_2_bits_uop_robIdx_value = _RANDOM[10'hAF][22:14];
        ld_in_reordered_res_0_1_2_bits_vaddr = {_RANDOM[10'hC5][31:14], _RANDOM[10'hC6]};
        ld_in_reordered_res_1_2_0_valid = _RANDOM[10'hDC][17];
        ld_in_reordered_res_1_2_0_bits_uop_pc =
          {_RANDOM[10'hDD][31:18], _RANDOM[10'hDE], _RANDOM[10'hDF][3:0]};
        ld_in_reordered_res_1_2_0_bits_uop_robIdx_flag = _RANDOM[10'hEF][10];
        ld_in_reordered_res_1_2_0_bits_uop_robIdx_value = _RANDOM[10'hEF][19:11];
        ld_in_reordered_res_1_2_0_bits_vaddr =
          {_RANDOM[10'h105][31:11], _RANDOM[10'h106][28:0]};
        ld_in_reordered_res_1_2_1_valid = _RANDOM[10'h11C][14];
        ld_in_reordered_res_1_2_1_bits_uop_pc =
          {_RANDOM[10'h11D][31:15], _RANDOM[10'h11E], _RANDOM[10'h11F][0]};
        ld_in_reordered_res_1_2_1_bits_uop_robIdx_flag = _RANDOM[10'h12F][7];
        ld_in_reordered_res_1_2_1_bits_uop_robIdx_value = _RANDOM[10'h12F][16:8];
        ld_in_reordered_res_1_2_1_bits_vaddr =
          {_RANDOM[10'h145][31:8], _RANDOM[10'h146][25:0]};
        ld_in_reordered_res_1_2_2_valid = _RANDOM[10'h15C][11];
        ld_in_reordered_res_1_2_2_bits_uop_pc =
          {_RANDOM[10'h15D][31:12], _RANDOM[10'h15E][29:0]};
        ld_in_reordered_res_1_2_2_bits_vaddr =
          {_RANDOM[10'h185][31:5], _RANDOM[10'h186][22:0]};
        ld_in_reordered_0_valid = _RANDOM[10'h19C][8];
        ld_in_reordered_0_bits_uop_pc = {_RANDOM[10'h19D][31:9], _RANDOM[10'h19E][26:0]};
        ld_in_reordered_0_bits_vaddr = {_RANDOM[10'h1C5][31:2], _RANDOM[10'h1C6][19:0]};
        ld_in_reordered_1_valid = _RANDOM[10'h1DC][5];
        ld_in_reordered_1_bits_uop_pc = {_RANDOM[10'h1DD][31:6], _RANDOM[10'h1DE][23:0]};
        ld_in_reordered_1_bits_vaddr =
          {_RANDOM[10'h204][31], _RANDOM[10'h205], _RANDOM[10'h206][16:0]};
        ld_in_reordered_2_valid = _RANDOM[10'h21C][2];
        ld_in_reordered_2_bits_uop_pc = {_RANDOM[10'h21D][31:3], _RANDOM[10'h21E][20:0]};
        ld_in_reordered_2_bits_vaddr =
          {_RANDOM[10'h244][31:28], _RANDOM[10'h245], _RANDOM[10'h246][13:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        valids_0 = 1'h0;
        valids_1 = 1'h0;
