  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        dataBuffer_uop_vpu_vstart = _RANDOM[6'h18][9:2];
        dataBuffer_uop_vpu_vuopIdx = _RANDOM[6'h18][28:22];
        dataBuffer_uop_vpu_veew = _RANDOM[6'h1D][10:9];
        dataBuffer_uop_uopIdx = _RANDOM[6'h1E][18:12];
        dataBuffer_uop_pdest = _RANDOM[6'h21][9:2];
        dataBuffer_uop_robIdx_flag = _RANDOM[6'h21][29];
        dataBuffer_uop_robIdx_value = {_RANDOM[6'h21][31:30], _RANDOM[6'h22][6:0]};
        dataBuffer_uop_lqIdx_flag = _RANDOM[6'h37][8];
        dataBuffer_uop_lqIdx_value = _RANDOM[6'h37][15:9];
        dataBuffer_uop_sqIdx_flag = _RANDOM[6'h37][16];
        dataBuffer_uop_sqIdx_value = _RANDOM[6'h37][22:17];
        dataBuffer_preIsSplit = _RANDOM[6'h3C][2];
        dataBuffer_mBIndex = _RANDOM[6'h3C][6:3];
        dataBuffer_alignedType = _RANDOM[6'h3C][9:7];
        dataBuffer_indexVlMaxInVd = _RANDOM[6'h3C][17:10];
        dataBuffer_usLowBitsAddr = _RANDOM[6'h3C][21:18];
        dataBuffer_usAligned128 = _RANDOM[6'h3C][22];
        dataBuffer_usMask = {_RANDOM[6'h3C][31:23], _RANDOM[6'h3D][22:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        state = 1'h0;
    end // initial
