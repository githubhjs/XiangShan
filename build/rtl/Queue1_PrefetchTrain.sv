...
module Queue1_PrefetchTrain(
  ...
  assign io_deq_bits_tag = ram[103:71];
  assign io_deq_bits_set = ram[70:62];
  assign io_deq_bits_needT = ram[61];
  assign io_deq_bits_source = ram[60:54];
  assign io_deq_bits_vaddr = ram[53:10];
