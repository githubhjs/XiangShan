  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        deqDelay_0_bits_rcIdx_0 = _RANDOM[2'h0][24:20];
        deqDelay_0_bits_fuType = {_RANDOM[2'h0][31:25], _RANDOM[2'h1][28:0]};
        deqDelay_0_bits_robIdx_flag = _RANDOM[2'h1][29];
        deqDelay_0_bits_robIdx_value = {_RANDOM[2'h1][31:30], _RANDOM[2'h2][6:0]};
        deqDelay_0_bits_rfRen_0 = _RANDOM[2'h2][12];
        deqDelay_0_bits_fpRen_0 = _RANDOM[2'h2][13];
        deqDelay_0_bits_psrc_0 = _RANDOM[2'h2][21:14];
        deqDelay_0_bits_dataSources_0_value = _RANDOM[2'h2][25:22];
        deqDelay_0_bits_exuSources_0_value = _RANDOM[2'h2][29:26];
        deqDelay_0_bits_loadDependency_0 = _RANDOM[2'h2][31:30];
        deqDelay_0_bits_loadDependency_1 = _RANDOM[2'h3][1:0];
        deqDelay_0_bits_loadDependency_2 = _RANDOM[2'h3][3:2];
        enqReady_last_REG = _RANDOM[2'h3][14];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        enqReady_last_REG = 1'h0;
    end // initial
