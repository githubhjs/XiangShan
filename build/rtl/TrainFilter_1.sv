...
module TrainFilter_1(
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    logic [31:0] _RANDOM[0:593];
    initial begin
      `ifdef INIT_RANDOM_PROLOG_
        `INIT_RANDOM_PROLOG_
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT
        for (logic [9:0] i = 10'h0; i < 10'h252; i += 10'h1) begin
          _RANDOM[i] = `RANDOM;
        end
        ...
        ld_in_reordered_res_0_1_0_bits_uop_robIdx_flag = _RANDOM[10'h26][1];
        ld_in_reordered_res_0_1_0_bits_uop_robIdx_value = _RANDOM[10'h26][10:2];
        ld_in_reordered_res_0_1_0_bits_vaddr =
          {_RANDOM[10'h3C][31:2], _RANDOM[10'h3D][19:0]};
        ld_in_reordered_res_0_1_0_bits_miss = _RANDOM[10'h47][23];
        ld_in_reordered_res_0_1_0_bits_meta_prefetch = _RANDOM[10'h52][18:16];
        ld_in_reordered_res_0_1_1_valid = _RANDOM[10'h53][5];
        ld_in_reordered_res_0_1_1_bits_uop_robIdx_flag = _RANDOM[10'h65][30];
        ld_in_reordered_res_0_1_1_bits_uop_robIdx_value =
          {_RANDOM[10'h65][31], _RANDOM[10'h66][7:0]};
        ld_in_reordered_res_0_1_1_bits_vaddr =
          {_RANDOM[10'h7B][31], _RANDOM[10'h7C], _RANDOM[10'h7D][16:0]};
        ld_in_reordered_res_0_1_1_bits_miss = _RANDOM[10'h87][20];
        ld_in_reordered_res_0_1_1_bits_meta_prefetch = _RANDOM[10'h92][15:13];
        ld_in_reordered_res_0_1_2_valid = _RANDOM[10'h93][2];
        ld_in_reordered_res_0_1_2_bits_uop_robIdx_flag = _RANDOM[10'hA5][27];
        ld_in_reordered_res_0_1_2_bits_uop_robIdx_value =
          {_RANDOM[10'hA5][31:28], _RANDOM[10'hA6][4:0]};
        ld_in_reordered_res_0_1_2_bits_vaddr =
          {_RANDOM[10'hBB][31:28], _RANDOM[10'hBC], _RANDOM[10'hBD][13:0]};
        ld_in_reordered_res_0_1_2_bits_miss = _RANDOM[10'hC7][17];
        ld_in_reordered_res_0_1_2_bits_meta_prefetch = _RANDOM[10'hD2][12:10];
        ld_in_reordered_res_1_2_0_valid = _RANDOM[10'hD2][31];
        ld_in_reordered_res_1_2_0_bits_uop_robIdx_flag = _RANDOM[10'hE5][24];
        ld_in_reordered_res_1_2_0_bits_uop_robIdx_value =
          {_RANDOM[10'hE5][31:25], _RANDOM[10'hE6][1:0]};
        ld_in_reordered_res_1_2_0_bits_vaddr =
          {_RANDOM[10'hFB][31:25], _RANDOM[10'hFC], _RANDOM[10'hFD][10:0]};
        ld_in_reordered_res_1_2_0_bits_miss = _RANDOM[10'h107][14];
        ld_in_reordered_res_1_2_0_bits_meta_prefetch = _RANDOM[10'h112][9:7];
        ld_in_reordered_res_1_2_1_valid = _RANDOM[10'h112][28];
        ld_in_reordered_res_1_2_1_bits_uop_robIdx_flag = _RANDOM[10'h125][21];
        ld_in_reordered_res_1_2_1_bits_uop_robIdx_value = _RANDOM[10'h125][30:22];
        ld_in_reordered_res_1_2_1_bits_vaddr =
          {_RANDOM[10'h13B][31:22], _RANDOM[10'h13C], _RANDOM[10'h13D][7:0]};
        ld_in_reordered_res_1_2_1_bits_miss = _RANDOM[10'h147][11];
        ld_in_reordered_res_1_2_1_bits_meta_prefetch = _RANDOM[10'h152][6:4];
        ld_in_reordered_res_1_2_2_valid = _RANDOM[10'h152][25];
        ld_in_reordered_res_1_2_2_bits_vaddr =
          {_RANDOM[10'h17B][31:19], _RANDOM[10'h17C], _RANDOM[10'h17D][4:0]};
        ld_in_reordered_res_1_2_2_bits_miss = _RANDOM[10'h187][8];
        ld_in_reordered_res_1_2_2_bits_meta_prefetch = _RANDOM[10'h192][3:1];
        ld_in_reordered_0_valid = _RANDOM[10'h192][22];
        ld_in_reordered_0_bits_vaddr =
          {_RANDOM[10'h1BB][31:16], _RANDOM[10'h1BC], _RANDOM[10'h1BD][1:0]};
        ld_in_reordered_0_bits_miss = _RANDOM[10'h1C7][5];
        ld_in_reordered_0_bits_meta_prefetch =
          {_RANDOM[10'h1D1][31:30], _RANDOM[10'h1D2][0]};
        ld_in_reordered_1_valid = _RANDOM[10'h1D2][19];
        ld_in_reordered_1_bits_vaddr = {_RANDOM[10'h1FB][31:13], _RANDOM[10'h1FC][30:0]};
        ld_in_reordered_1_bits_miss = _RANDOM[10'h207][2];
        ld_in_reordered_1_bits_meta_prefetch = _RANDOM[10'h211][29:27];
        ld_in_reordered_2_valid = _RANDOM[10'h212][16];
        ld_in_reordered_2_bits_vaddr = {_RANDOM[10'h23B][31:10], _RANDOM[10'h23C][27:0]};
        ld_in_reordered_2_bits_miss = _RANDOM[10'h246][31];
        ld_in_reordered_2_bits_meta_prefetch = _RANDOM[10'h251][26:24];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        valids_0 = 1'h0;
        valids_1 = 1'h0;
