  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        deqDelay_0_bits_rcIdx_1 = {_RANDOM[3'h0][31:29], _RANDOM[3'h1][1:0]};
        deqDelay_0_bits_fuType = {_RANDOM[3'h1][31:2], _RANDOM[3'h2][5:0]};
        deqDelay_0_bits_robIdx_flag = _RANDOM[3'h2][6];
        deqDelay_0_bits_robIdx_value = _RANDOM[3'h2][15:7];
        deqDelay_0_bits_rfRen_0 = _RANDOM[3'h2][22];
        deqDelay_0_bits_rfRen_1 = _RANDOM[3'h2][23];
        deqDelay_0_bits_rfWen = _RANDOM[3'h2][24];
        deqDelay_0_bits_pdest = {_RANDOM[3'h2][31:25], _RANDOM[3'h3][0]};
        deqDelay_0_bits_psrc_0 = _RANDOM[3'h3][8:1];
        deqDelay_0_bits_psrc_1 = _RANDOM[3'h3][16:9];
        deqDelay_0_bits_dataSources_0_value = _RANDOM[3'h3][20:17];
        deqDelay_0_bits_dataSources_1_value = _RANDOM[3'h3][24:21];
        deqDelay_0_bits_exuSources_0_value = _RANDOM[3'h3][28:25];
        deqDelay_0_bits_exuSources_1_value = {_RANDOM[3'h3][31:29], _RANDOM[3'h4][0]};
        deqDelay_0_bits_loadDependency_0 = _RANDOM[3'h4][2:1];
        deqDelay_0_bits_loadDependency_1 = _RANDOM[3'h4][4:3];
        deqDelay_0_bits_loadDependency_2 = _RANDOM[3'h4][6:5];
        io_validCntDeqVec_0_REG_1 = _RANDOM[3'h4][18:13];
        enqReady_last_REG = _RANDOM[3'h4][19];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        enqReady_last_REG = 1'h0;
    end // initial
