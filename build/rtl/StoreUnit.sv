...
module StoreUnit(
  ...
  input         io_misalign_stin_bits_uop_isRVC,
  input  [5:0]  io_misalign_stin_bits_uop_ftqPtr_value,
  input  [4:0]  io_misalign_stin_bits_uop_ftqOffset,
  ...
  input  [8:0]  io_misalign_stin_bits_uop_robIdx_value,
  ...
  output [8:0]  io_misalign_stout_bits_uop_robIdx_value,
  ...
  output        io_lsq_bits_isFirstIssue,
  ...
  output [8:0]  io_lsq_replenish_uop_robIdx_value,
  ...
  output [8:0]  io_stld_nuke_query_bits_robIdx_value,
  ...
  output        io_stout_bits_robIdx_flag,
  output [8:0]  io_stout_bits_robIdx_value,
  output        io_stout_bits_exceptionVec_3,
  output        io_stout_bits_exceptionVec_6,
  output        io_stout_bits_exceptionVec_7,
  output        io_stout_bits_exceptionVec_15,
  output        io_stout_bits_exceptionVec_19,
  output        io_stout_bits_exceptionVec_23,
  output [3:0]  io_stout_bits_trigger,
  ...
  input  [8:0]  io_sqCommitRobIdx_value,
  ...
  wire [6:0]  s0_stin_fuOpType = io_stin_ready_0 ? io_stin_bits_fuOpType[6:0] : 7'h0;
  wire [63:0] s0_stin_src_0 = io_stin_ready_0 ? io_stin_bits_src_0 : 64'h0;
  wire [11:0] s0_stin_imm = io_stin_ready_0 ? io_stin_bits_imm[11:0] : 12'h0;
  ...
  wire [9:0]  _s0_misalignNeedReplay_T_4 = {s0_uop_robIdx_flag, s0_uop_robIdx_value};
  wire [9:0]  _sx_ready_1_flushItself_T_2 =
  ...
  wire [49:0] _s0_saddr_T_3 =
    50'(s0_stin_src_0[49:0] + {{38{s0_stin_imm[11]}}, s0_stin_imm});
  ...
  wire        s0_isCbo =
    io_stin_ready_0
    & ((&(s0_stin_fuOpType[3:2])) & ~(|(s0_stin_fuOpType[6:4]))
       | s0_stin_fuOpType[3:0] == 4'h7);
  ...
  wire [22:0] _s0_mask_T_14 =
    {15'h0,
     {4'h0,
      {2'h0, {1'h0, s0_uop_fuOpType[1:0] == 2'h0} | {2{s0_uop_fuOpType[1:0] == 2'h1}}}
        | {4{s0_uop_fuOpType[1:0] == 2'h2}}} | {8{&(s0_uop_fuOpType[1:0])}}}
    << _s0_saddr_T_3[3:0];
  wire [15:0] _s0_out_mask_T_14 =
    s0_rs_corss16Bytes & ~s0_addr_aligned
      ...
      : io_misalign_stin_valid
          ...
          : io_stin_ready_0
              ? (s0_isCbo ? 16'hFFFF : _s0_mask_T_14[15:0])
  ...
  reg  [8:0]  io_updateLFST_bits_robIdx_r_value;
  reg  [4:0]  io_updateLFST_bits_ssid_r;
  reg         io_updateLFST_bits_storeSetHit_r;
  ...
  wire        s1_exception_new_vec_6 = s1_out_mmio & s1_in_isMisalign;
  ...
  reg  [8:0]  s2_in_uop_robIdx_value;
  ...
  wire        s2_exception =
    ...
    & (|{s2_trigger_debug_mode,
         ...
         s2_in_uop_exceptionVec_3}) & s2_vecActive;
  ...
  wire [9:0]  _s2_vecFeedback_flushItself_T_1 =
  ...
  reg         sx_valid_1_r;
  reg         sx_in_1_r_output_robIdx_flag;
  reg  [8:0]  sx_in_1_r_output_robIdx_value;
  reg         sx_in_1_r_output_exceptionVec_3;
  reg         sx_in_1_r_output_exceptionVec_6;
  reg         sx_in_1_r_output_exceptionVec_7;
  reg         sx_in_1_r_output_exceptionVec_15;
  reg         sx_in_1_r_output_exceptionVec_19;
  reg         sx_in_1_r_output_exceptionVec_23;
  reg  [3:0]  sx_in_1_r_output_trigger;
  ...
  wire        cur_kill =
    io_redirect_valid
    & (io_redirect_bits_level
       & {sx_in_1_r_output_robIdx_flag,
          sx_in_1_r_output_robIdx_value} == _sx_ready_1_flushItself_T_2
       | sx_in_1_r_output_robIdx_flag ^ io_redirect_bits_robIdx_flag
       ^ sx_in_1_r_output_robIdx_value > io_redirect_bits_robIdx_value);
  ...
  wire        s0_out_misalignWith16Byte =
    _s0_addr_Up_low_T_11[4] == s0_vaddr[4] & ~s0_addr_aligned;
  always @(posedge clock) begin
    if (_s0_fire_T_1) begin
      ...
      s1_in_uop_isRVC <=
        io_misalign_stin_valid
          ? io_misalign_stin_bits_uop_isRVC
          : io_stin_ready_0
              ? io_stin_bits_isRVC
              : s0_out_isvec & io_vecstin_bits_uop_isRVC;
      ...
      s1_in_uop_ftqOffset <=
        io_misalign_stin_valid
          ...
          : io_stin_ready_0
              ...
              : s0_out_isvec ? io_vecstin_bits_uop_ftqOffset : 5'h0;
    ...
    if (s0_valid) begin
      io_updateLFST_bits_robIdx_r_value <=
        io_stin_ready_0 ? io_stin_bits_robIdx_value : 9'h0;
      io_updateLFST_bits_ssid_r <= io_stin_ready_0 ? io_stin_bits_ssid : 5'h0;
      io_updateLFST_bits_storeSetHit_r <= io_stin_ready_0 & io_stin_bits_storeSetHit;
    end
    if (_s1_fire_T_1) begin
      ...
      s2_isCbo <= s1_isCbo;
      s2_mis_align_r <=
        s1_valid & ~s1_tlb_miss & ~s1_isCbo & s1_pbmt != 2'h1 & s1_pbmt != 2'h2
    ...
    if (_prev_fire_T_4) begin
      sx_in_1_r_output_robIdx_flag <= s3_in_uop_robIdx_flag;
      sx_in_1_r_output_robIdx_value <= s3_in_uop_robIdx_value;
      sx_in_1_r_output_exceptionVec_3 <= s3_in_uop_exceptionVec_3;
      sx_in_1_r_output_exceptionVec_6 <= s3_in_uop_exceptionVec_6;
      sx_in_1_r_output_exceptionVec_7 <= s3_in_uop_exceptionVec_7;
      sx_in_1_r_output_exceptionVec_15 <= s3_in_uop_exceptionVec_15;
      sx_in_1_r_output_exceptionVec_19 <= s3_in_uop_exceptionVec_19;
      sx_in_1_r_output_exceptionVec_23 <= s3_in_uop_exceptionVec_23;
      sx_in_1_r_output_trigger <= s3_in_uop_trigger;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s1_in_uop_isRVC = _RANDOM[9'h5][27];
        s1_in_uop_ftqPtr_value = _RANDOM[9'h6][5:0];
        s1_in_uop_ftqOffset = _RANDOM[9'h6][10:6];
        s1_in_uop_fuOpType = _RANDOM[9'h8][19:11];
        s1_in_uop_uopIdx = _RANDOM[9'h11][14:8];
        s1_in_uop_robIdx_flag = _RANDOM[9'h14][25];
        s1_in_uop_robIdx_value = {_RANDOM[9'h14][31:26], _RANDOM[9'h15][2:0]};
        s1_in_uop_sqIdx_flag = _RANDOM[9'h2A][12];
        s1_in_uop_sqIdx_value = _RANDOM[9'h2A][18:13];
        s1_in_vaddr = {_RANDOM[9'h2A][31:26], _RANDOM[9'h2B], _RANDOM[9'h2C][11:0]};
        s1_in_mask = {_RANDOM[9'h31][31:29], _RANDOM[9'h32][12:0]};
        s1_in_wlineflag = _RANDOM[9'h36][14];
        s1_in_isvec = _RANDOM[9'h3B][14];
        s1_in_is128bit = _RANDOM[9'h3B][16];
        s1_in_elemIdx = _RANDOM[9'h3B][26:19];
        s1_in_alignedType = _RANDOM[9'h3B][29:27];
        s1_in_mbIndex = {_RANDOM[9'h3B][31:30], _RANDOM[9'h3C][1:0]};
        s1_in_vecActive = _RANDOM[9'h40][3];
        s1_in_isFirstIssue = _RANDOM[9'h40][12];
        s1_in_isFrmMisAlignBuf = _RANDOM[9'h41][2];
        s1_in_isMisalign = _RANDOM[9'h41][3];
        s1_in_isFinalSplit = _RANDOM[9'h41][4];
        s1_in_misalignWith16Byte = _RANDOM[9'h41][5];
        s1_vecActive = _RANDOM[9'h41][8];
        s1_isCbo = _RANDOM[9'h41][9];
        s1_isvec = _RANDOM[9'h41][10];
        s1_misalignNeedReplay = _RANDOM[9'h41][11];
        s1_frm_mab_vec = _RANDOM[9'h41][12];
        io_updateLFST_bits_robIdx_r_value = _RANDOM[9'h41][22:14];
        io_updateLFST_bits_ssid_r = _RANDOM[9'h41][27:23];
        io_updateLFST_bits_storeSetHit_r = _RANDOM[9'h41][28];
        s1_mis_align_last_REG = _RANDOM[9'h43][30];
        s1_toMisalignBufferValid_last_REG = _RANDOM[9'h43][31];
        s2_valid = _RANDOM[9'h44][0];
        s2_in_uop_exceptionVec_3 = _RANDOM[9'h47][0];
        s2_in_uop_exceptionVec_7 = _RANDOM[9'h47][4];
        s2_in_uop_exceptionVec_15 = _RANDOM[9'h47][12];
        s2_in_uop_exceptionVec_19 = _RANDOM[9'h47][16];
        s2_in_uop_exceptionVec_23 = _RANDOM[9'h47][20];
        s2_in_uop_trigger = _RANDOM[9'h47][26:23];
        s2_in_uop_fuOpType = _RANDOM[9'h4A][19:11];
        s2_in_uop_robIdx_flag = _RANDOM[9'h56][25];
        s2_in_uop_robIdx_value = {_RANDOM[9'h56][31:26], _RANDOM[9'h57][2:0]};
        s2_in_uop_sqIdx_flag = _RANDOM[9'h6C][12];
        s2_in_uop_sqIdx_value = _RANDOM[9'h6C][18:13];
        s2_in_fullva = {_RANDOM[9'h6E][31:12], _RANDOM[9'h6F], _RANDOM[9'h70][11:0]};
        s2_in_vaNeedExt = _RANDOM[9'h70][12];
        s2_in_paddr = {_RANDOM[9'h70][31:13], _RANDOM[9'h71][28:0]};
        s2_in_gpaddr = {_RANDOM[9'h71][31:29], _RANDOM[9'h72], _RANDOM[9'h73][28:0]};
        s2_in_mask = {_RANDOM[9'h73][31:29], _RANDOM[9'h74][12:0]};
        s2_in_nc = _RANDOM[9'h78][19];
        s2_in_mmio = _RANDOM[9'h78][20];
        s2_in_isHyper = _RANDOM[9'h78][23];
        s2_in_isForVSnonLeafPTE = _RANDOM[9'h78][24];
        s2_in_isvec = _RANDOM[9'h7D][14];
        s2_in_elemIdx = _RANDOM[9'h7D][26:19];
        s2_in_mbIndex = {_RANDOM[9'h7D][31:30], _RANDOM[9'h7E][1:0]};
        s2_in_vecActive = _RANDOM[9'h82][3];
        s2_in_isFrmMisAlignBuf = _RANDOM[9'h83][2];
        s2_in_isMisalign = _RANDOM[9'h83][3];
        s2_in_isFinalSplit = _RANDOM[9'h83][4];
        s2_vecActive = _RANDOM[9'h83][8];
        s2_frm_mab_vec = _RANDOM[9'h83][9];
        s2_pbmt = _RANDOM[9'h83][11:10];
        s2_trigger_debug_mode = _RANDOM[9'h83][12];
        s2_tlb_hit = _RANDOM[9'h83][13];
        s2_exception_REG = _RANDOM[9'h83][14];
        s2_un_misalign_exception_REG = _RANDOM[9'h83][15];
        s2_mmio_REG = _RANDOM[9'h83][16];
        s2_actually_uncache_REG = _RANDOM[9'h83][17];
        s2_isCbo = _RANDOM[9'h83][18];
        s2_out_uop_exceptionVec_7_REG = _RANDOM[9'h83][19];
        s2_mis_align_r = _RANDOM[9'h83][20];
        s2_misalignNeedReplay = _RANDOM[9'h83][21];
        io_feedback_slow_valid_last_REG = _RANDOM[9'h83][22];
        io_feedback_slow_bits_hit_r = _RANDOM[9'h84][29];
        s2_vecFeedback_REG = _RANDOM[9'h84][30];
        s2_misalign_stout_bits_need_rep_r = _RANDOM[9'h84][31];
        s3_valid = _RANDOM[9'hC4][10];
        s3_in_uop_exceptionVec_3 = _RANDOM[9'hC7][10];
        s3_in_uop_exceptionVec_6 = _RANDOM[9'hC7][13];
        s3_in_uop_exceptionVec_7 = _RANDOM[9'hC7][14];
        s3_in_uop_exceptionVec_15 = _RANDOM[9'hC7][22];
        s3_in_uop_exceptionVec_19 = _RANDOM[9'hC7][26];
        s3_in_uop_exceptionVec_23 = _RANDOM[9'hC7][30];
        s3_in_uop_trigger = _RANDOM[9'hC8][4:1];
        s3_in_uop_robIdx_flag = _RANDOM[9'hD7][3];
        s3_in_uop_robIdx_value = _RANDOM[9'hD7][12:4];
        s3_in_fullva = {_RANDOM[9'hEE][31:22], _RANDOM[9'hEF], _RANDOM[9'hF0][21:0]};
        s3_in_vaNeedExt = _RANDOM[9'hF0][22];
        s3_in_gpaddr = {_RANDOM[9'hF2][31:7], _RANDOM[9'hF3], _RANDOM[9'hF4][6:0]};
        s3_in_mask = _RANDOM[9'hF4][22:7];
        s3_in_nc = _RANDOM[9'hF8][29];
        s3_in_mmio = _RANDOM[9'hF8][30];
        s3_in_memBackTypeMM = _RANDOM[9'hF8][31];
        s3_in_isForVSnonLeafPTE = _RANDOM[9'hF9][2];
        s3_in_isvec = _RANDOM[9'hFD][24];
        s3_in_elemIdx = {_RANDOM[9'hFD][31:29], _RANDOM[9'hFE][4:0]};
        s3_in_mbIndex = _RANDOM[9'hFE][11:8];
        s3_vecFeedback = _RANDOM[9'h103][18];
        s3_exception = _RANDOM[9'h103][19];
        sx_valid_1_r = _RANDOM[9'h103][20];
        sx_in_1_r_output_robIdx_flag = _RANDOM[9'h105][29];
        sx_in_1_r_output_robIdx_value = {_RANDOM[9'h105][31:30], _RANDOM[9'h106][6:0]};
        sx_in_1_r_output_exceptionVec_3 = _RANDOM[9'h106][11];
        sx_in_1_r_output_exceptionVec_6 = _RANDOM[9'h106][14];
        sx_in_1_r_output_exceptionVec_7 = _RANDOM[9'h106][15];
        sx_in_1_r_output_exceptionVec_15 = _RANDOM[9'h106][23];
        sx_in_1_r_output_exceptionVec_19 = _RANDOM[9'h106][27];
        sx_in_1_r_output_exceptionVec_23 = _RANDOM[9'h106][31];
        sx_in_1_r_output_trigger = _RANDOM[9'h107][10:7];
        sx_in_1_r_output_debug_isMMIO = _RANDOM[9'h107][12];
        sx_in_1_r_output_debug_isNCIO = _RANDOM[9'h107][13];
        sx_in_1_r_vecFeedback = _RANDOM[9'h10A][17];
        sx_in_1_r_hasException = _RANDOM[9'h10A][21];
        sx_in_1_r_elemIdx = _RANDOM[9'h10A][29:22];
        sx_in_1_r_mbIndex = _RANDOM[9'h10B][4:1];
        sx_in_1_r_mask = _RANDOM[9'h10B][20:5];
        sx_in_1_r_vaddr =
          {_RANDOM[9'h10B][31:21], _RANDOM[9'h10C], _RANDOM[9'h10D][20:0]};
        sx_in_1_r_vaNeedExt = _RANDOM[9'h10D][21];
        sx_in_1_r_gpaddr =
          {_RANDOM[9'h10D][31:22], _RANDOM[9'h10E], _RANDOM[9'h10F][7:0]};
        sx_in_1_r_isForVSnonLeafPTE = _RANDOM[9'h10F][8];
        sx_in_vec_1_r = _RANDOM[9'h10F][25];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        s1_valid = 1'h0;
        s1_vecActive = 1'h1;
  ...
  assign io_updateLFST_valid =
    s1_valid & ~s1_tlb_miss & ~s1_isvec & ~s1_in_isFrmMisAlignBuf;
  assign io_updateLFST_bits_robIdx_value = io_updateLFST_bits_robIdx_r_value;
  assign io_updateLFST_bits_ssid = io_updateLFST_bits_ssid_r;
  assign io_updateLFST_bits_storeSetHit = io_updateLFST_bits_storeSetHit_r;
  ...
  assign io_tlb_req_bits_fullva =
    io_stin_ready_0
      ? 64'(s0_stin_src_0 + {{52{s0_stin_imm[11]}}, s0_stin_imm})
      : s0_out_isvec
  ...
  assign io_tlb_req_bits_cmd =
    {2'h0, ~(io_stin_ready_0 & (&(s0_stin_fuOpType[3:2])) & ~(|(s0_stin_fuOpType[6:4])))};
  ...
  assign io_tlb_req_bits_debug_robIdx_value =
    s0_use_non_prf_flow ? s0_uop_robIdx_value : 9'h0;
  ...
  assign io_lsq_bits_uop_isRVC = s1_in_uop_isRVC;
  ...
  assign io_lsq_bits_isFirstIssue = s1_in_isFirstIssue;
  ...
  assign io_lsq_replenish_hasException =
    ((|{s2_in_uop_exceptionVec_23,
        ...
        s2_out_af,
        s2_exception_new_vec_6,
        s2_in_uop_exceptionVec_3}) | s2_in_uop_trigger == 4'h1 | s2_out_af) & s2_valid
    & ~s2_kill;
  ...
  assign io_prefetch_train_bits_uop_robIdx_flag = 1'h0;
  assign io_prefetch_train_bits_uop_robIdx_value = 9'h0;
  assign io_prefetch_train_bits_vaddr = 50'h0;
  assign io_prefetch_train_bits_paddr = 48'h0;
  assign io_prefetch_train_bits_tlbMiss = 1'h0;
  assign io_prefetch_train_bits_isFirstIssue = 1'h0;
  ...
  assign io_stout_bits_robIdx_flag = sx_in_1_r_output_robIdx_flag;
  assign io_stout_bits_robIdx_value = sx_in_1_r_output_robIdx_value;
  assign io_stout_bits_exceptionVec_3 = sx_in_1_r_output_exceptionVec_3;
  assign io_stout_bits_exceptionVec_6 = sx_in_1_r_output_exceptionVec_6;
  assign io_stout_bits_exceptionVec_7 = sx_in_1_r_output_exceptionVec_7;
  assign io_stout_bits_exceptionVec_15 = sx_in_1_r_output_exceptionVec_15;
  assign io_stout_bits_exceptionVec_19 = sx_in_1_r_output_exceptionVec_19;
  assign io_stout_bits_exceptionVec_23 = sx_in_1_r_output_exceptionVec_23;
  assign io_stout_bits_trigger = sx_in_1_r_output_trigger;
  ...
  assign io_vecstout_bits_trigger = sx_in_1_r_output_trigger;
  assign io_vecstout_bits_exceptionVec_3 = sx_in_1_r_output_exceptionVec_3;
  assign io_vecstout_bits_exceptionVec_6 = sx_in_1_r_output_exceptionVec_6;
  assign io_vecstout_bits_exceptionVec_7 = sx_in_1_r_output_exceptionVec_7;
  assign io_vecstout_bits_exceptionVec_15 = sx_in_1_r_output_exceptionVec_15;
  assign io_vecstout_bits_exceptionVec_19 = sx_in_1_r_output_exceptionVec_19;
  assign io_vecstout_bits_exceptionVec_23 = sx_in_1_r_output_exceptionVec_23;
  ...
  assign io_misalign_enq_req_bits_uop_isRVC = s1_in_uop_isRVC;
  assign io_misalign_enq_req_bits_uop_ftqPtr_value = s1_in_uop_ftqPtr_value;
  assign io_misalign_enq_req_bits_uop_ftqOffset = s1_in_uop_ftqOffset;
