...
module DatamoduleResultBuffer(
  ...
  wire         _GEN_3 = _GEN_2 & ~_enq_flag_T_4;
  wire         _GEN_4 = _GEN_2 & _enq_flag_T_4;
  always @(posedge clock) begin
    ...
    data_0_sqNeedDeq <= _GEN_3 ? io_enq_1_bits_sqNeedDeq : _GEN_0 | data_0_sqNeedDeq;
    if (_GEN_4) begin
    ...
    data_1_sqNeedDeq <= _GEN_4 ? io_enq_1_bits_sqNeedDeq : _GEN_1 | data_1_sqNeedDeq;
  end // always @(posedge)
  wire         _GEN_5 = _entry_allowin_1_T_1 & ~deq_flag;
  wire         _GEN_6 = _entry_allowin_1_T_1 & deq_flag;
  wire         _GEN_7 =
    _entry_allowin_1_T_6 ? ~(~_deq_flag_T_4 | _GEN_5) & valids_0 : ~_GEN_5 & valids_0;
  wire         _GEN_8 =
    _entry_allowin_1_T_6 ? ~(_deq_flag_T_4 | _GEN_6) & valids_1 : ~_GEN_6 & valids_1;
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      valids_0 <= _GEN_2 ? ~_enq_flag_T_4 | _GEN_0 | _GEN_7 : _GEN_0 | _GEN_7;
      valids_1 <= _GEN_2 ? _enq_flag_T_4 | _GEN_1 | _GEN_8 : _GEN_1 | _GEN_8;
