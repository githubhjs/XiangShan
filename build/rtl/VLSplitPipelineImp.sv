  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s1_in_r_uop_vpu_vma = _RANDOM[6'h17][21];
        s1_in_r_uop_vpu_vta = _RANDOM[6'h17][22];
        s1_in_r_uop_vpu_vsew = _RANDOM[6'h17][24:23];
        s1_in_r_uop_vpu_vlmul = _RANDOM[6'h17][27:25];
        s1_in_r_uop_vpu_vm = _RANDOM[6'h18][4];
        s1_in_r_uop_vpu_vstart = _RANDOM[6'h18][12:5];
        s1_in_r_uop_vpu_vuopIdx = _RANDOM[6'h18][31:25];
        s1_in_r_uop_vpu_vl = _RANDOM[6'h1D][8:1];
        s1_in_r_uop_vpu_nf = _RANDOM[6'h1D][11:9];
        s1_in_r_uop_vpu_veew = _RANDOM[6'h1D][13:12];
        s1_in_r_uop_uopIdx = _RANDOM[6'h1E][21:15];
        s1_in_r_uop_pdest = _RANDOM[6'h21][12:5];
        s1_in_r_uop_robIdx_flag = _RANDOM[6'h22][0];
        s1_in_r_uop_robIdx_value = _RANDOM[6'h22][9:1];
        s1_in_r_uop_lqIdx_flag = _RANDOM[6'h37][11];
        s1_in_r_uop_lqIdx_value = _RANDOM[6'h37][18:12];
        s1_in_r_uop_sqIdx_flag = _RANDOM[6'h37][19];
        s1_in_r_uop_sqIdx_value = _RANDOM[6'h37][25:20];
        s1_in_r_fof = _RANDOM[6'h38][1];
        s1_in_r_vdIdxInField = _RANDOM[6'h38][4:2];
        s1_in_r_preIsSplit = _RANDOM[6'h3C][5];
        s1_in_r_alignedType = _RANDOM[6'h3C][12:10];
        s1_in_r_indexVlMaxInVd = _RANDOM[6'h3C][20:13];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        s1_valid = 1'h0;
    end // initial
