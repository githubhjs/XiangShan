...
module LqExceptionBuffer(
  ...
  input  [8:0]  io_req_3_bits_uop_robIdx_value,
  ...
  input  [8:0]  io_req_4_bits_uop_robIdx_value,
  ...
  input  [8:0]  io_req_5_bits_uop_robIdx_value,
  ...
  reg  [8:0]  s2_valid_REG_7_bits_robIdx_value;
  wire [9:0]  _s2_valid_flushItself_T_29 =
  ...
  reg  [8:0]  s2_valid_REG_9_bits_robIdx_value;
  wire [9:0]  _s2_valid_flushItself_T_37 =
  ...
  reg  [8:0]  s2_valid_REG_11_bits_robIdx_value;
  wire [9:0]  _s2_valid_flushItself_T_45 =
  ...
  always @(posedge clock) begin
    ...
    req_uop_lqIdx_flag <=
      _reqSel_oldest_T
        ? (_reqSel_oldest_T_1
             ? reqSel_res_1_bits_uop_lqIdx_flag
             : reqSel_res_0_bits_uop_lqIdx_flag)
        : _reqSel_oldest_T_4
            ? reqSel_res_0_bits_uop_lqIdx_flag
            : reqSel_res_1_bits_uop_lqIdx_flag;
    req_vaNeedExt <=
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    logic [31:0] _RANDOM[0:627];
    initial begin
      `ifdef INIT_RANDOM_PROLOG_
        `INIT_RANDOM_PROLOG_
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT
        for (logic [9:0] i = 10'h0; i < 10'h274; i += 10'h1) begin
          _RANDOM[i] = `RANDOM;
        end
        req_valid = _RANDOM[10'h0][0];
        req_uop_robIdx_flag = _RANDOM[10'h12][25];
        req_uop_robIdx_value = {_RANDOM[10'h12][31:26], _RANDOM[10'h13][2:0]};
        req_uop_lqIdx_flag = _RANDOM[10'h28][4];
        req_uop_lqIdx_value = _RANDOM[10'h28][11:5];
        req_fullva = {_RANDOM[10'h2A][31:12], _RANDOM[10'h2B], _RANDOM[10'h2C][11:0]};
        req_vaNeedExt = _RANDOM[10'h2C][12];
        req_gpaddr = {_RANDOM[10'h2D][31:29], _RANDOM[10'h2E], _RANDOM[10'h2F][28:0]};
        req_isHyper = _RANDOM[10'h34][23];
        req_isForVSnonLeafPTE = _RANDOM[10'h34][24];
        s2_req_0_uop_exceptionVec_3 = _RANDOM[10'h55][25];
        s2_req_0_uop_exceptionVec_4 = _RANDOM[10'h55][26];
        s2_req_0_uop_exceptionVec_5 = _RANDOM[10'h55][27];
        s2_req_0_uop_exceptionVec_13 = _RANDOM[10'h56][3];
        s2_req_0_uop_exceptionVec_19 = _RANDOM[10'h56][9];
        s2_req_0_uop_exceptionVec_21 = _RANDOM[10'h56][11];
        s2_req_0_uop_robIdx_flag = _RANDOM[10'h65][18];
        s2_req_0_uop_robIdx_value = _RANDOM[10'h65][27:19];
        s2_req_0_uop_lqIdx_flag = _RANDOM[10'h7A][29];
        s2_req_0_uop_lqIdx_value = {_RANDOM[10'h7A][31:30], _RANDOM[10'h7B][4:0]};
        s2_req_0_fullva = {_RANDOM[10'h7D][31:5], _RANDOM[10'h7E], _RANDOM[10'h7F][4:0]};
        s2_req_0_vaNeedExt = _RANDOM[10'h7F][5];
        s2_req_0_gpaddr =
          {_RANDOM[10'h80][31:22], _RANDOM[10'h81], _RANDOM[10'h82][21:0]};
        s2_req_0_isHyper = _RANDOM[10'h87][16];
        s2_req_0_isForVSnonLeafPTE = _RANDOM[10'h87][17];
        s2_req_1_uop_exceptionVec_3 = _RANDOM[10'hA8][18];
        s2_req_1_uop_exceptionVec_4 = _RANDOM[10'hA8][19];
        s2_req_1_uop_exceptionVec_5 = _RANDOM[10'hA8][20];
        s2_req_1_uop_exceptionVec_13 = _RANDOM[10'hA8][28];
        s2_req_1_uop_exceptionVec_19 = _RANDOM[10'hA9][2];
        s2_req_1_uop_exceptionVec_21 = _RANDOM[10'hA9][4];
        s2_req_1_uop_robIdx_flag = _RANDOM[10'hB8][11];
        s2_req_1_uop_robIdx_value = _RANDOM[10'hB8][20:12];
        s2_req_1_uop_lqIdx_flag = _RANDOM[10'hCD][22];
        s2_req_1_uop_lqIdx_value = _RANDOM[10'hCD][29:23];
        s2_req_1_fullva =
          {_RANDOM[10'hCF][31:30], _RANDOM[10'hD0], _RANDOM[10'hD1][29:0]};
        s2_req_1_vaNeedExt = _RANDOM[10'hD1][30];
        s2_req_1_gpaddr =
          {_RANDOM[10'hD3][31:15], _RANDOM[10'hD4], _RANDOM[10'hD5][14:0]};
        s2_req_1_isHyper = _RANDOM[10'hDA][9];
        s2_req_1_isForVSnonLeafPTE = _RANDOM[10'hDA][10];
        s2_req_2_uop_exceptionVec_3 = _RANDOM[10'hFB][11];
        s2_req_2_uop_exceptionVec_4 = _RANDOM[10'hFB][12];
        s2_req_2_uop_exceptionVec_5 = _RANDOM[10'hFB][13];
        s2_req_2_uop_exceptionVec_13 = _RANDOM[10'hFB][21];
        s2_req_2_uop_exceptionVec_19 = _RANDOM[10'hFB][27];
        s2_req_2_uop_exceptionVec_21 = _RANDOM[10'hFB][29];
        s2_req_2_uop_robIdx_flag = _RANDOM[10'h10B][4];
        s2_req_2_uop_robIdx_value = _RANDOM[10'h10B][13:5];
        s2_req_2_uop_lqIdx_flag = _RANDOM[10'h120][15];
        s2_req_2_uop_lqIdx_value = _RANDOM[10'h120][22:16];
        s2_req_2_fullva =
          {_RANDOM[10'h122][31:23], _RANDOM[10'h123], _RANDOM[10'h124][22:0]};
        s2_req_2_vaNeedExt = _RANDOM[10'h124][23];
        s2_req_2_gpaddr =
          {_RANDOM[10'h126][31:8], _RANDOM[10'h127], _RANDOM[10'h128][7:0]};
        s2_req_2_isHyper = _RANDOM[10'h12D][2];
        s2_req_2_isForVSnonLeafPTE = _RANDOM[10'h12D][3];
        s2_req_3_uop_exceptionVec_3 = _RANDOM[10'h14E][4];
        s2_req_3_uop_exceptionVec_4 = _RANDOM[10'h14E][5];
        s2_req_3_uop_exceptionVec_5 = _RANDOM[10'h14E][6];
        s2_req_3_uop_exceptionVec_13 = _RANDOM[10'h14E][14];
        s2_req_3_uop_exceptionVec_19 = _RANDOM[10'h14E][20];
        s2_req_3_uop_exceptionVec_21 = _RANDOM[10'h14E][22];
        s2_req_3_uop_robIdx_flag = _RANDOM[10'h15D][29];
        s2_req_3_uop_robIdx_value = {_RANDOM[10'h15D][31:30], _RANDOM[10'h15E][6:0]};
        s2_req_3_fullva =
          {_RANDOM[10'h175][31:16], _RANDOM[10'h176], _RANDOM[10'h177][15:0]};
        s2_req_3_vaNeedExt = _RANDOM[10'h177][16];
        s2_req_3_gpaddr = {_RANDOM[10'h179][31:1], _RANDOM[10'h17A], _RANDOM[10'h17B][0]};
        s2_req_4_uop_exceptionVec_3 = _RANDOM[10'h1A0][29];
        s2_req_4_uop_exceptionVec_4 = _RANDOM[10'h1A0][30];
        s2_req_4_uop_exceptionVec_5 = _RANDOM[10'h1A0][31];
        s2_req_4_uop_exceptionVec_13 = _RANDOM[10'h1A1][7];
        s2_req_4_uop_exceptionVec_19 = _RANDOM[10'h1A1][13];
        s2_req_4_uop_exceptionVec_21 = _RANDOM[10'h1A1][15];
        s2_req_4_uop_robIdx_flag = _RANDOM[10'h1B0][22];
        s2_req_4_uop_robIdx_value = _RANDOM[10'h1B0][31:23];
        s2_req_4_fullva =
          {_RANDOM[10'h1C8][31:9], _RANDOM[10'h1C9], _RANDOM[10'h1CA][8:0]};
        s2_req_4_vaNeedExt = _RANDOM[10'h1CA][9];
        s2_req_4_gpaddr =
          {_RANDOM[10'h1CB][31:26], _RANDOM[10'h1CC], _RANDOM[10'h1CD][25:0]};
        s2_req_5_uop_exceptionVec_3 = _RANDOM[10'h1F3][22];
        s2_req_5_uop_exceptionVec_4 = _RANDOM[10'h1F3][23];
        s2_req_5_uop_exceptionVec_5 = _RANDOM[10'h1F3][24];
        s2_req_5_uop_exceptionVec_13 = _RANDOM[10'h1F4][0];
        s2_req_5_uop_exceptionVec_19 = _RANDOM[10'h1F4][6];
        s2_req_5_uop_exceptionVec_21 = _RANDOM[10'h1F4][8];
        s2_req_5_uop_robIdx_flag = _RANDOM[10'h203][15];
        s2_req_5_uop_robIdx_value = _RANDOM[10'h203][24:16];
        s2_req_5_uop_lqIdx_flag = _RANDOM[10'h218][26];
        s2_req_5_uop_lqIdx_value = {_RANDOM[10'h218][31:27], _RANDOM[10'h219][1:0]};
        s2_req_5_fullva =
          {_RANDOM[10'h21B][31:2], _RANDOM[10'h21C], _RANDOM[10'h21D][1:0]};
        s2_req_5_gpaddr =
          {_RANDOM[10'h21E][31:19], _RANDOM[10'h21F], _RANDOM[10'h220][18:0]};
        s2_req_5_isHyper = _RANDOM[10'h225][13];
        s2_req_5_isForVSnonLeafPTE = _RANDOM[10'h225][14];
        s2_valid_REG = _RANDOM[10'h243][16];
        s2_valid_REG_1_valid = _RANDOM[10'h243][17];
        s2_valid_REG_1_bits_level = _RANDOM[10'h247][8];
        s2_valid_REG_1_bits_robIdx_flag = _RANDOM[10'h247][12];
        s2_valid_REG_1_bits_robIdx_value = _RANDOM[10'h247][21:13];
        s2_valid_REG_2 = _RANDOM[10'h24C][7];
        s2_valid_REG_3_valid = _RANDOM[10'h24C][8];
        s2_valid_REG_3_bits_level = _RANDOM[10'h24F][31];
        s2_valid_REG_3_bits_robIdx_flag = _RANDOM[10'h250][3];
        s2_valid_REG_3_bits_robIdx_value = _RANDOM[10'h250][12:4];
        s2_valid_REG_4 = _RANDOM[10'h254][30];
        s2_valid_REG_5_valid = _RANDOM[10'h254][31];
        s2_valid_REG_5_bits_level = _RANDOM[10'h258][22];
        s2_valid_REG_5_bits_robIdx_flag = _RANDOM[10'h258][26];
        s2_valid_REG_5_bits_robIdx_value =
          {_RANDOM[10'h258][31:27], _RANDOM[10'h259][3:0]};
        s2_valid_REG_6 = _RANDOM[10'h25D][21];
        s2_valid_REG_7_valid = _RANDOM[10'h25D][22];
        s2_valid_REG_7_bits_level = _RANDOM[10'h261][13];
        s2_valid_REG_7_bits_robIdx_flag = _RANDOM[10'h261][17];
        s2_valid_REG_7_bits_robIdx_value = _RANDOM[10'h261][26:18];
        s2_valid_REG_8 = _RANDOM[10'h266][12];
        s2_valid_REG_9_valid = _RANDOM[10'h266][13];
        s2_valid_REG_9_bits_level = _RANDOM[10'h26A][4];
        s2_valid_REG_9_bits_robIdx_flag = _RANDOM[10'h26A][8];
        s2_valid_REG_9_bits_robIdx_value = _RANDOM[10'h26A][17:9];
        s2_valid_REG_10 = _RANDOM[10'h26F][3];
        s2_valid_REG_11_valid = _RANDOM[10'h26F][4];
        s2_valid_REG_11_bits_level = _RANDOM[10'h272][27];
        s2_valid_REG_11_bits_robIdx_flag = _RANDOM[10'h272][31];
        s2_valid_REG_11_bits_robIdx_value = _RANDOM[10'h273][8:0];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        req_valid = 1'h0;
    end // initial
