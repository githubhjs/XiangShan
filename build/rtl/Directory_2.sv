...
module Directory_2(
  ...
  wire [30:0]      _tagWrite_syndromeUInt_T_12 =
    {5'h0, io_tagWReq_bits_wtag[25:11], 11'h0};
  ...
  wire             origin_bit_opt_io_w_req_bits_data_7 = resetFinish & hit_s3;
  ...
  SRAMTemplate_290 replacer_sram_opt (
    .clock                          (clock),
    .reset                          (reset),
    .io_r_req_valid                 (tagArray_io_r_req_valid),
    .io_r_req_bits_setIdx           (io_read_bits_set),
  ...
  SRAMTemplate_291 origin_bit_opt (
    .clock                          (clock),
    .reset                          (reset),
    .io_r_req_valid                 (tagArray_io_r_req_valid),
    .io_r_req_bits_setIdx           (io_read_bits_set),
