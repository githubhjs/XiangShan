  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        req_vaddr = {_RANDOM[7'h28][31:26], _RANDOM[7'h29], _RANDOM[7'h2A][11:0]};
        req_fullva = {_RANDOM[7'h2A][31:12], _RANDOM[7'h2B], _RANDOM[7'h2C][11:0]};
        req_paddr = {_RANDOM[7'h2C][31:13], _RANDOM[7'h2D][28:0]};
        req_gpaddr = {_RANDOM[7'h2D][31:29], _RANDOM[7'h2E], _RANDOM[7'h2F][28:0]};
        req_mask = {_RANDOM[7'h2F][31:29], _RANDOM[7'h30][12:0]};
        req_nc = _RANDOM[7'h34][19];
        req_mmio = _RANDOM[7'h34][20];
        req_memBackTypeMM = _RANDOM[7'h34][21];
        req_isHyper = _RANDOM[7'h34][23];
        req_isForVSnonLeafPTE = _RANDOM[7'h34][24];
        req_isvec = _RANDOM[7'h39][14];
        req_is128bit = _RANDOM[7'h39][16];
        req_vecActive = _RANDOM[7'h3E][3];
        req_schedIndex = {_RANDOM[7'h3E][31:26], _RANDOM[7'h3F][0]};
        slaveAccept = _RANDOM[7'h52][26];
        slaveId = _RANDOM[7'h52][30:27];
        uncacheState = {_RANDOM[7'h52][31], _RANDOM[7'h53][0]};
        uncacheData = {_RANDOM[7'h53][31:1], _RANDOM[7'h54], _RANDOM[7'h55][0]};
        denied = _RANDOM[7'h55][2];
        corrupt = _RANDOM[7'h55][3];
        needFlushReg = _RANDOM[7'h55][4];
        pendingPtr_next_r_flag = _RANDOM[7'h55][5];
        pendingPtr_next_r_value = _RANDOM[7'h55][14:6];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        req_valid = 1'h0;
        slaveAccept = 1'h0;
