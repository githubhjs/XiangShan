  ...
  always @(posedge clock) begin
    if (activated)
      pipelineDataOutReg <=
        ...
        | {33'h0, selected_1 ? toNextPipeline_1_outdata : 104'h0}
        | (selected_2 ? toNextPipeline_2_outdata : 137'h0)
        | {33'h0, selected_3 ? toNextPipeline_3_outdata : 104'h0}
        | (selected_4 ? toNextPipeline_4_outdata : 137'h0)
        | {33'h0, selected_5 ? toNextPipeline_5_outdata : 104'h0}
        | (selected_6 ? toNextPipeline_6_outdata : 137'h0)
        | {33'h0, selected_7 ? toNextPipeline_7_outdata : 104'h0}
