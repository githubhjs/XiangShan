...
module TLBNonBlock_2(
  ...
  wire             readResult_lastCycleRedirect =
    ...
    & (readResult_lastCycleRedirect_REG_bits_level
       & {readResult_lastCycleRedirect_REG_bits_robIdx_flag,
          readResult_lastCycleRedirect_REG_bits_robIdx_value} == 10'h0
       | readResult_lastCycleRedirect_REG_bits_robIdx_flag);
  ...
  wire             _readResult_T_26 =
    ...
    & ~(io_redirect_valid
        & (io_redirect_bits_level & _readResult_flushItself_T_10 == 10'h0
           | io_redirect_bits_robIdx_flag)) & ~readResult_lastCycleRedirect;
  ...
  wire [47:0]      io_requestor_0_resp_bits_paddr_0_0 =
    portTranslateEnable_0
      ...
      : useReqS1Paddr_0 ? 48'h0 : req_out_0_vaddr[47:0];
  ...
  wire             hasPf =
    (_io_requestor_0_resp_bits_excp_0_pf_ld_T_1
     ...
     | ~readResult_0_4_0_a & isInst) & s1_valid & ~af_3 & ~isFakePte & ~isNonLeaf;
  wire             io_requestor_0_resp_bits_excp_0_gpf_ld_0 =
    ((~((readResult_p_hit_last_REG
        ...
        & readResult_0_5_0_x) | readResult_0_5_0_pf) & isLd | ~readResult_0_5_0_a & isLd)
    & s2_valid & ~af_3 & ~hasPf;
  assign hasGpf_0 =
    hit_read_0
  ...
  wire             _GEN_29 = _readResult_T_8 | ~_readResult_T_26;
  wire             _GEN_30 = _readResult_T_44 | ~_readResult_T_62;
  wire             _GEN_31 = _readResult_T_80 | ~_readResult_T_98;
  wire             _GEN_32 = prepf_1 | pregpf_1 | preaf_1;
  wire             _GEN_33 = prepf_2 | pregpf_2 | preaf_2;
  always @(posedge clock) begin
    ...
    need_gpa_robidx_flag <=
      _GEN_31
        ? (_GEN_30 ? _GEN_29 & need_gpa_robidx_flag : req_out_1_debug_robIdx_flag)
        : req_out_2_debug_robIdx_flag;
    if (_GEN_31) begin
      if (_GEN_30) begin
        if (_GEN_29) begin
        end
        else
          need_gpa_robidx_value <= 9'h0;
      end
      else
  ...
  wire [2:0]       _readResult_s1tag_T_2 = _GEN_36 | _GEN_37;
  ...
  wire [3:0]       _GEN_39 =
    {{io_ptw_resp_bits_s1_entry_n & (|io_ptw_resp_bits_s2_entry_level)
     ...
     {io_ptw_resp_bits_s1_entry_n},
     {io_ptw_resp_bits_s1_entry_n}};
  wire [2:0]       _readResult_s1tag_T_10 = _GEN_36 | _GEN_37;
  ...
  wire [3:0]       _GEN_41 =
    {{io_ptw_resp_bits_s1_entry_n & (|io_ptw_resp_bits_s2_entry_level)
     ...
     {io_ptw_resp_bits_s1_entry_n},
     {io_ptw_resp_bits_s1_entry_n}};
  wire [2:0]       _readResult_s1tag_T_18 = _GEN_36 | _GEN_37;
  wire [3:0][37:0] _GEN_42 =
    {{{io_ptw_resp_bits_s2_entry_tag[37:27], need_gpa_vpn[26:0]}},
     ...
     {_GEN_41[io_ptw_resp_bits_s2xlate]
  ...
  wire [3:0][37:0] _GEN_44 =
    {{{io_ptw_resp_bits_s2_entry_tag[37:27], need_gpa_vpn[26:0]}},
     {{io_ptw_resp_bits_s2_entry_tag[37:18], need_gpa_vpn[17:0]}},
     {{io_ptw_resp_bits_s2_entry_tag[37:9], need_gpa_vpn[8:0]}},
     {_GEN_39[io_ptw_resp_bits_s2xlate]
        ? {io_ptw_resp_bits_s2_entry_tag[37:4], need_gpa_vpn[3:0]}
        : io_ptw_resp_bits_s2_entry_tag}};
  ...
  wire [3:0][37:0] _GEN_46 =
    {{{io_ptw_resp_bits_s2_entry_tag[37:27], need_gpa_vpn[26:0]}},
     {{io_ptw_resp_bits_s2_entry_tag[37:18], need_gpa_vpn[17:0]}},
     {{io_ptw_resp_bits_s2_entry_tag[37:9], need_gpa_vpn[8:0]}},
     {_GEN_35[io_ptw_resp_bits_s2xlate]
        ? {io_ptw_resp_bits_s2_entry_tag[37:4], need_gpa_vpn[3:0]}
        : io_ptw_resp_bits_s2_entry_tag}};
      ...
      resp_gpa_refill <=
        ...
        & (io_ptw_resp_valid & need_gpa
           & need_gpa_vpn == (_ptw_just_back_T_21
                                ? _GEN_42[_GEN_40[io_ptw_resp_bits_s2xlate]]
                                : _GEN_43[_GEN_40[io_ptw_resp_bits_s2xlate]])
           | ~(_readResult_T_44 | _readResult_T_62)
           & (io_ptw_resp_valid & need_gpa
              & need_gpa_vpn == (_ptw_just_back_T_21
                                   ? _GEN_44[_GEN_38[io_ptw_resp_bits_s2xlate]]
                                   : _GEN_45[_GEN_38[io_ptw_resp_bits_s2xlate]])
              | ~(_readResult_T_8 | _readResult_T_26)
              & (io_ptw_resp_valid & need_gpa
                 & need_gpa_vpn == (_ptw_just_back_T_21
                                      ? _GEN_46[_GEN_34[io_ptw_resp_bits_s2xlate]]
                                      : _GEN_47[_GEN_34[io_ptw_resp_bits_s2xlate]])
                 | resp_gpa_refill)));
      readResult_p_hit_last_REG <=
        (_ptw_just_back_T_20
           ? (_ptw_just_back_noS2_hit_asid_hit_T_2 | io_ptw_resp_bits_s1_entry_perm_g)
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        useReqS1Paddr_0 = _RANDOM[7'h1B][15];
        ...
        readResult_p_perm_d = _RANDOM[7'h23][29];
        ...
        readResult_p_g_perm_d = _RANDOM[7'h25][21];
        readResult_p_g_perm_a = _RANDOM[7'h25][22];
        readResult_p_g_perm_x = _RANDOM[7'h25][25];
        readResult_p_g_perm_w = _RANDOM[7'h25][26];
        readResult_p_g_perm_r = _RANDOM[7'h25][27];
        readResult_lastCycleRedirect_REG_valid = _RANDOM[7'h26][2];
        readResult_lastCycleRedirect_REG_bits_level = _RANDOM[7'h29][25];
        readResult_lastCycleRedirect_REG_bits_robIdx_flag = _RANDOM[7'h29][29];
        readResult_lastCycleRedirect_REG_bits_robIdx_value =
          {_RANDOM[7'h29][31:30], _RANDOM[7'h2A][6:0]};
        ...
        noTranslateReg = _RANDOM[7'h47][29];
  ...
  assign io_requestor_0_resp_bits_excp_0_af_ld =
    af_3 & ~(|(req_out_0_cmd[1:0])) & (s1_valid | s2_valid);
  ...
  assign io_pmp_0_bits_addr = noTranslateReg ? 48'h0 : io_requestor_0_resp_bits_paddr_0_0;
