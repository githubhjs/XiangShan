...
module HuanCun(
  ...
  Pipeline_47 slices_ecc_ecc_buffer_0 (
    .clock               (clock),
    .reset               (reset),
  ...
  Pipeline_47 slices_ecc_ecc_buffer_1 (
    .clock               (clock),
    .reset               (reset),
  ...
  Pipeline_47 slices_ecc_ecc_buffer_2 (
    .clock               (clock),
    .reset               (reset),
  ...
  Pipeline_47 slices_ecc_ecc_buffer_3 (
    .clock               (clock),
    .reset               (reset),
  ...
  Pipeline_51 ctl_reqs_req_buffer_0 (
    .clock              (clock),
    .reset              (reset),
  ...
  Pipeline_51 ctl_reqs_req_buffer_1 (
    .clock              (clock),
    .reset              (reset),
  ...
  Pipeline_51 ctl_reqs_req_buffer_2 (
    .clock              (clock),
    .reset              (reset),
  ...
  Pipeline_51 ctl_reqs_req_buffer_3 (
    .clock              (clock),
    .reset              (reset),
  ...
  Pipeline_55 ctl_resps_resp_buffer_0 (
    .clock              (clock),
    .reset              (reset),
  ...
  Pipeline_55 ctl_resps_resp_buffer_1 (
    .clock              (clock),
    .reset              (reset),
  ...
  Pipeline_55 ctl_resps_resp_buffer_2 (
    .clock              (clock),
    .reset              (reset),
  ...
  Pipeline_55 ctl_resps_resp_buffer_3 (
    .clock              (clock),
    .reset              (reset),
