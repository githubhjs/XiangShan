  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        deqDelay_0_bits_vecWen = _RANDOM[3'h2][16];
        deqDelay_0_bits_v0Wen = _RANDOM[3'h2][17];
        deqDelay_0_bits_vlWen = _RANDOM[3'h2][18];
        deqDelay_0_bits_pdest = _RANDOM[3'h2][25:19];
        deqDelay_0_bits_pdestVl = _RANDOM[3'h2][30:26];
        deqDelay_0_bits_ftqIdx_flag = _RANDOM[3'h2][31];
        deqDelay_0_bits_ftqIdx_value = _RANDOM[3'h3][5:0];
        deqDelay_0_bits_ftqOffset = _RANDOM[3'h3][10:6];
        deqDelay_0_bits_psrc_0 = _RANDOM[3'h3][17:11];
        deqDelay_0_bits_psrc_1 = _RANDOM[3'h3][24:18];
        deqDelay_0_bits_psrc_2 = _RANDOM[3'h3][31:25];
        deqDelay_0_bits_psrc_3 = _RANDOM[3'h4][6:0];
        deqDelay_0_bits_psrcVl = _RANDOM[3'h4][11:7];
        deqDelay_0_bits_dataSources_0_value = _RANDOM[3'h4][15:12];
        deqDelay_0_bits_dataSources_1_value = _RANDOM[3'h4][19:16];
        deqDelay_0_bits_dataSources_2_value = _RANDOM[3'h4][23:20];
        deqDelay_0_bits_dataSources_3_value = _RANDOM[3'h4][27:24];
        io_validCntDeqVec_0_REG_1 = _RANDOM[3'h5][5:1];
        enqReady_last_REG = _RANDOM[3'h5][6];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        enqReady_last_REG = 1'h0;
    end // initial
