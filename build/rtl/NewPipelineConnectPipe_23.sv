  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        data_uop_isRVC = _RANDOM[6'h8][9];
        data_uop_ftqPtr_flag = _RANDOM[6'h8][13];
        data_uop_ftqPtr_value = _RANDOM[6'h8][19:14];
        data_uop_ftqOffset = _RANDOM[6'h8][24:20];
        data_uop_fuOpType = {_RANDOM[6'hA][31:25], _RANDOM[6'hB][1:0]};
        data_uop_rfWen = _RANDOM[6'hB][2];
        data_uop_fpWen = _RANDOM[6'hB][3];
        data_uop_vpu_vstart = _RANDOM[6'hD][19:12];
        data_uop_vpu_veew = _RANDOM[6'h12][20:19];
        data_uop_uopIdx = _RANDOM[6'h13][28:22];
        data_uop_pdest = _RANDOM[6'h16][19:12];
        data_uop_robIdx_flag = _RANDOM[6'h17][7];
        data_uop_robIdx_value = _RANDOM[6'h17][16:8];
        data_uop_storeSetHit = _RANDOM[6'h2C][0];
        data_uop_waitForRobIdx_flag = _RANDOM[6'h2C][1];
        data_uop_waitForRobIdx_value = _RANDOM[6'h2C][10:2];
        data_uop_loadWaitBit = _RANDOM[6'h2C][11];
        data_uop_loadWaitStrict = _RANDOM[6'h2C][12];
        data_uop_lqIdx_flag = _RANDOM[6'h2C][18];
        data_uop_lqIdx_value = _RANDOM[6'h2C][25:19];
        data_uop_sqIdx_flag = _RANDOM[6'h2C][26];
        data_uop_sqIdx_value = {_RANDOM[6'h2C][31:27], _RANDOM[6'h2D][0]};
        data_mBIndex = _RANDOM[6'h2D][12:9];
        data_elemIdx = _RANDOM[6'h2D][20:13];
        data_elemIdxInsideVd = _RANDOM[6'h2D][28:21];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        valid = 1'h0;
    end // initial
