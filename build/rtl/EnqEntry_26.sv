  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        enqDelayValidReg_last_REG = _RANDOM[3'h7][3];
        io_commonOut_entry_bits_payload_og1Payload_REG_fuOpType = _RANDOM[3'h7][12:4];
        io_commonOut_entry_bits_payload_og1Payload_REG_fpu_wflags = _RANDOM[3'h7][13];
        io_commonOut_entry_bits_payload_og1Payload_REG_fpu_fmt = _RANDOM[3'h7][15:14];
        io_commonOut_entry_bits_payload_og1Payload_REG_fpu_rm = _RANDOM[3'h7][18:16];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        validReg_last_REG = 1'h0;
        enqDelayValidReg_last_REG = 1'h0;
