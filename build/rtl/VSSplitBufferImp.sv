...
module VSSplitBufferImp(
  ...
  input  [8:0]   io_vstdMisalign_storeMisalignBufferRobIdx_value,
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        uopq_uop_vpu_vstart = _RANDOM[7'h18][8:1];
        uopq_uop_vpu_vuopIdx = _RANDOM[7'h18][27:21];
        uopq_uop_vpu_veew = _RANDOM[7'h1D][9:8];
        uopq_uop_uopIdx = _RANDOM[7'h1E][17:11];
        uopq_uop_pdest = _RANDOM[7'h21][8:1];
        uopq_uop_robIdx_flag = _RANDOM[7'h21][28];
        uopq_uop_robIdx_value = {_RANDOM[7'h21][31:29], _RANDOM[7'h22][5:0]};
        uopq_uop_lqIdx_flag = _RANDOM[7'h37][7];
        uopq_uop_lqIdx_value = _RANDOM[7'h37][14:8];
        uopq_uop_sqIdx_flag = _RANDOM[7'h37][15];
        uopq_uop_sqIdx_value = _RANDOM[7'h37][21:16];
        uopq_preIsSplit = _RANDOM[7'h3C][1];
        uopq_mBIndex = _RANDOM[7'h3C][5:2];
        uopq_alignedType = _RANDOM[7'h3C][8:6];
        uopq_indexVlMaxInVd = _RANDOM[7'h3C][16:9];
        uopq_usLowBitsAddr = _RANDOM[7'h3C][20:17];
        uopq_usAligned128 = _RANDOM[7'h3C][21];
        uopq_usMask = {_RANDOM[7'h3C][31:22], _RANDOM[7'h3D][21:0]};
        allocated = _RANDOM[7'h3D][22];
        splitIdx = _RANDOM[7'h3D][27:23];
        strideOffsetReg =
          {_RANDOM[7'h3D][31:28],
           _RANDOM[7'h3E],
           _RANDOM[7'h3F],
