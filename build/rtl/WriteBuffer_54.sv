...
module WriteBuffer_54(
  ...
  wire            _GEN_22 = _GEN_21 | _GEN_17;
  wire            _GEN_23 = hitRowIdxVec_0 == 2'h1;
  wire            _GEN_24 = _GEN_23 | _GEN_18;
  wire            _GEN_25 = hitRowIdxVec_0 == 2'h2;
  wire            _GEN_26 = _GEN_25 | _GEN_19;
  ...
  wire            _GEN_28 =
    {_GEN[hitRowIdxVec_0],
     ...
     _GEN_8[hitRowIdxVec_0]} == {io_write_0_bits_setIdx,
                                 io_write_0_bits_wayMask_7,
                                 io_write_0_bits_wayMask_6,
                                 io_write_0_bits_wayMask_5,
                                 io_write_0_bits_wayMask_4,
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      needWrite_0_0 <=
        ...
        & (io_write_0_valid
             ? (_GEN_29 ? _GEN_17 | needWrite_0_0 : _GEN_22 | needWrite_0_0)
             : needWrite_0_0);
      needWrite_0_1 <=
        ~(_GEN_30 & readIdx == 2'h1)
        & (io_write_0_valid
             ? (_GEN_29 ? _GEN_18 | needWrite_0_1 : _GEN_24 | needWrite_0_1)
             : needWrite_0_1);
      needWrite_0_2 <=
      ...
      if (io_write_0_valid
          & (hit
               ? (hitNotWritten ? _GEN_22 : hitWritten & ~_GEN_28 & _GEN_21 | _GEN_17)
               : _GEN_17)) begin
      ...
      if (io_write_0_valid
          & (hit
               ? (hitNotWritten ? _GEN_24 : hitWritten & ~_GEN_28 & _GEN_23 | _GEN_18)
               : _GEN_18)) begin
      ...
      if (io_write_0_valid
          & (hit
               ? (hitNotWritten ? _GEN_26 : hitWritten & ~_GEN_28 & _GEN_25 | _GEN_19)
               : _GEN_19)) begin
      ...
      if (io_write_0_valid
          & (hit
               ? (hitNotWritten
                    ? _GEN_27
                    : hitWritten & ~_GEN_28 & (&hitRowIdxVec_0) | _GEN_20)
               : _GEN_20)) begin
      ...
      if (io_write_0_valid) begin
        valids_0_0 <= _GEN_31 ? _GEN_22 | valids_0_0 : _GEN_17 | valids_0_0;
        valids_0_1 <= _GEN_31 ? _GEN_24 | valids_0_1 : _GEN_18 | valids_0_1;
  ...
  assign io_read_0_bits_entryVec_0_ctr_value = _GEN_8[readIdx];
  assign io_read_0_bits_entryVec_1_ctr_value = _GEN_9[readIdx];
  assign io_read_0_bits_entryVec_2_ctr_value = _GEN_10[readIdx];
  assign io_read_0_bits_entryVec_3_ctr_value = _GEN_11[readIdx];
  assign io_read_0_bits_entryVec_4_ctr_value = _GEN_12[readIdx];
  assign io_read_0_bits_entryVec_5_ctr_value = _GEN_13[readIdx];
  assign io_read_0_bits_entryVec_6_ctr_value = _GEN_14[readIdx];
  assign io_read_0_bits_entryVec_7_ctr_value = _GEN_15[readIdx];
endmodule
